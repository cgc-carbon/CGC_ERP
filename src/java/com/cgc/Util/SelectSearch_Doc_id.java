...
public class SelectSearch_Doc_id {
        ...
        switch (inputpage) {
            ...
            case 25:
                if (inputdatabase.equals("vd_carbon_friction_header")) {
                    strColoum = new String[]{"doc_id", "doc_date", "doc_time", "shift", "report_id", "remark", "sum_up_silo", "sum_to_jumbo"};
                } else {
            ...
            case 27:
                if (inputdatabase.equals("vd_carbon_burn_in_header")) {
                    strColoum = new String[]{"doc_id", "doc_date", "doc_date", "time_to", "time_from", "runner_id", "runner_name", "shift", "burn_no", "wh_in", "wh_out", "total_weight", "total_weight", "tank_qty", "operate_id", "wh_in_name", "wh_out_name", "operate_name", "remark", "bu", "iod"};
                } else {
                ...
                break;
            case 29:
                strColoum = new String[]{"doc_id", "doc_date", "work_date", "time_from", "time_to", "runner_id", "full_name", "shift", "wh_in", "wh_out", "burn_no", "product_id", "ch_from", "ch_to", "weight_split", "burn_out_date", "total_weight", "total_weight", "lost_weight", "lost_weight", "wh_in_name", "wh_out_name", "report_id", "report_full_name"};
                break;
            case 31:
                strColoum = new String[]{"doc_id", "doc_date"};
                break;
            case 32:
                strColoum = new String[]{"doc_id", "doc_date", "cust_id", "cust_name", "po_no", "contain_date", "iso_no", "country", "country_name", "lot_no", "mark_sign", "base_plate", "base_plate_desc", "base_plate_qty", "detail", "approve", "approve_name", "mark_sign_desc", "quality_dep", "quality_dep_name", "prod_dep", "prod_dep_name", "wh_dep", "wh_dep_name", "sale_confirm", "quality_confirm", "prod_confirm", "wh_confirm", "i2", "deadline", "stock_prod"};
                break;
            case 34:
                strColoum = new String[]{"doc_id", "doc_date", "doc_time", "work_type", "wh_in", "wh_out", "prd_emp_id", "prd_emp_name", "wh_emp_id", "wh_emp_name", "wh_sup_id", "wh_sup_name", "wh_in_name", "wh_out_name", "work_type_id"};
                break;
            case 36:
                if (inputdatabase.equals("vd_product_receive_header")) {
                    strColoum = new String[]{"doc_id", "job_id", "doc_date", "product_id", "size", "ctc_i2", "inc_bal", "palate_no", "wh_in", "wh_out", "cust_name", "mashed_machine_chk", "pan_chk", "roast_chk", "mag_chk", "pill_flat_chk", "roast_edit_chk", "wash_chk", "ball_mill_chk", "job_edit_chk", "mashed_machine", "pan", "ball_mill", "pill_flat", "mag", "job_edit", "wash", "roast", "roast_edit", "wh_in_name", "wh_out_name", "remark", "doc_type_job_id"};
                } else {
            ...
            case 42:
                ...
                break;
            case 46:
                strColoum = new String[]{"doc_id", "doc_date", "car_no", "sender_id", "c_type", "report_name", "approve_name", "sender_full_name", "report_full_name", "approve_full_name", "car_date_in", "approve_status"};
                break;
            case 103:
            ...
            case 313://d_carbon_out_analysis
                strColoum = new String[]{"doc_id", "doc_date", "reporter_id", "reporter_name", "approve_id", "approve_name", "tdate1", "tname1", "ttime1", "tdate2", "tname2", "ttime2", "tdate3", "tname3", "ttime3", "approve_status"};
                break;
            case 322:
                strColoum = new String[]{"doc_id", "doc_date", "cust_id", "cust_name", "po_no", "contain_date", "iso_no", "country", "country_name", "lot_no", "mark_sign", "base_plate", "base_plate_desc", "base_plate_qty", "detail", "approve", "approve_name", "mark_sign_desc", "quality_dep", "quality_dep_name", "prod_dep", "prod_dep_name", "wh_dep", "wh_dep_name", "sale_confirm", "quality_confirm", "prod_confirm", "wh_confirm", "i2", "deadline", "stock_prod"};
                break;
    ...
    public String SelectID(int inputpage, String inputdatabase)//function Return ค่าของ Textfill ของหน้าที่จะนำไปลงข้อมูล
    {
        switch (inputpage) {
            ...
            case 25:
                if (inputdatabase.equals("vd_carbon_friction_header")) {
                    strID = "doc_id|doc_date|doc_time|shift|report_id|remark|sum_up_silo|sum_to_jumbo";
                } else {
            ...
            case 27:
                if (inputdatabase.equals("vd_carbon_burn_in_header")) {
                    strID = "doc_id|doc_date|date_ck|time_to|time_from|runner_id|runner_id_desc|shift|burn_no|wh_in|wh_out|total_weight|total_weight_chk|tank_qty|operate_id|wh_in_desc|wh_out_desc|operate_id_desc|remark|bu|iod";
                } else {
                ...
                break;
            case 29:
                strID = "doc_id|doc_date|work_date|time_from|time_to|runner_id|runner_id_desc|shift|wh_in|wh_out|burn_no|product_id|ch_from|ch_to|weight_split|burn_out_date|total_weight|total_weight_chk|lost_weight|lost_weight_chk|wh_in_desc|wh_out_desc|report_id|report_id_desc";
                break;
            case 31:
                strID = "doc_id|doc_date";
                break;
            case 32:
                strID = "doc_id|doc_date|cust_id|cust_id_desc|po_no|contain_date|iso_no|country_id|country_id_desc|lot_no|mark_sign|base_plate|base_plate_desc|base_plate_qty|remark|approve|approve_desc|mark_sign_desc|quality_dep|quality_dep_desc|prod_dep|prod_dep_desc|wh_dep|wh_dep_desc|sale_confirm|quality_confirm|prod_confirm|wh_confirm|iod2|deadline|stock_prod";
                break;
            case 34:
                strID = "doc_id|doc_date|doc_time|work_type|wh_in|wh_out|prd_emp_id|prd_emp_id_desc|wh_emp_id|wh_emp_id_desc|wh_sup_id|wh_sup_id_desc|wh_in_desc|wh_out_desc|work_type_id";
                break;
            case 36:
                if (inputdatabase.equals("vd_product_receive_header")) {
                    strID = "doc_id|job_id|doc_date|product_id|size|ctc_i2|inc_bal|palate_no|wh_in|wh_out|job_id_desc|mashed_machine_chk|pan_chk|roast_chk|mag_chk|pill_flat_chk|roast_edit_chk|wash_chk|ball_mill_chk|job_edit_chk|mashed_machine|pan|ball_mill|pill_flat|mag|job_edit|wash|roast|roast_edit|wh_in_desc|wh_out_desc|remark|job_id_end";
                } else {
            ...
            case 41:
                ...
                break;                
            case 46:
                strID = "doc_id|doc_date|car_no|sender_id|c_type|report_id|approve_id|sender_id_desc|report_id_desc|approve_id_desc|car_date_in|approve_status";
                break;
            case 103:
            ...
            case 309:
                ...
                break;
            case 313:
                strID = "doc_id|doc_date|reporter_id|reporter_id_desc|approve_id|approve_id_desc|tdate1|tname1|ttime1|tdate2|tname2|ttime2|tdate3|tname3|ttime3|approve_status";
                break;
            case 322:
                strID = "doc_id|doc_date|cust_id|cust_id_desc|po_no|contain_date|iso_no|country_id|country_id_desc|lot_no|mark_sign|base_plate|base_plate_desc|base_plate_qty|remark|approve|approve_desc|mark_sign_desc|quality_dep|quality_dep_desc|prod_dep|prod_dep_desc|wh_dep|wh_dep_desc|sale_confirm|quality_confirm|prod_confirm|wh_confirm|iod2|deadline|stock_prod";
                break;
