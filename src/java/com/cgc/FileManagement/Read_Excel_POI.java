...
//อ่านFile นามสกุล xls
    ...
    public void Read_XLS() throws Exception {
        String output = "";
        FileInputStream file = new FileInputStream(new File("D:\\workspace\\CGC_ERP\\Source\\CGC_ERP\\build\\web\\UPLOADS\\File", "Test1.xls"));
        try {
    ...
    public void Read_XLSX() throws Exception {
        String output = "";
        FileInputStream file = new FileInputStream(new File("D:\\workspace\\CGC_ERP\\Source\\CGC_ERP\\build\\web\\UPLOADS\\File", "Test1.xlsx"));
        try {
