...
public class D_rawmatt_analyze_headerDAO {
    ...
    public int insert(DataBeanD_rawmatt_analyze_header dataBean) throws Exception {
        ...
        String sql = "insert into d_rawmatt_analyze_header (doc_id,car_no,sender_id,c_type,doc_date,report_name,approve_name,create_date,update_date,create_by,car_date_in,approve_status) values(?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public int update(DataBeanD_rawmatt_analyze_header dataBean) throws Exception {
        ...
        String sql =
                "update d_rawmatt_analyze_header set  car_no=?,sender_id=?,c_type=?,doc_date=?,report_name=?,approve_name=?,update_date=?,update_by=?,car_date_in=?,approve_status=?  where doc_id=? and complete_flag ='N' and delete_flag ='N'";
        PreparedStatement p = null;
        ResultSet rs = null;
        try {
            p = con.prepareStatement(sql);
