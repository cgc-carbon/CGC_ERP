        ...
        try {
            ...
            while (rs.next()) {
                ...
                strOutput += (Process_id.equals("PR_022"))
                        ? "<td class='forborder' width='3px'><input type='checkbox' id='ckbox_" + count + "' name='ckbox' value ='" + count + "' onclick=\"cancle_chkboxAll('chk_all',this.checked)\"></td>\n"
                        : "<td class='forborder' width='3px'><input type='checkbox' id='ckbox_" + rs.getString("line_no") + "' name='ckbox' value ='" + rs.getString("line_no") + "' onclick=\"cancle_chkboxAll('chk_all',this.checked)\"></td>\n";
                strOutput += (Process_id.equals("PR_022"))
                        ? "<td class='forborder' width='3%'>" + count + "</td>\n"
                        : "<td class='forborder' width='3%'>" + rs.getString("line_no") + "</td>\n";
                strOutput += "<td class='forborder' width='14%'>" + rs.getString("doc_id") + "</td>\n";
                ...
                strOutput += (Process_id.equals("PR_040") || Process_id.equals("PR_042"))
                        ...
                        ? "<td class='forborder' width='10%'>-<input type = 'hidden' id='job_id_" + count + "' name = 'job_id' value = '-'></td>\n"
                        : "<td class='forborder' width='10%'>-<input type = 'hidden' id='job_id_" + rs.getString("line_no") + "' name = 'job_id' value = '-'></td>\n";
                strOutput += (Process_id.equals("PR_022"))
                        ? "<td class='forborder' width='10%'>" + rs.getString(objprocess.Return_FillProduct_id()) + "<input type='hidden' id='product_doc_id_" + count + "' name = 'product_doc_id' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "'></td>\n"
                        : "<td class='forborder' width='10%'>" + rs.getString(objprocess.Return_FillProduct_id()) + "<input type='hidden' id='product_doc_id_" + rs.getString("line_no") + "' name = 'product_doc_id' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "'></td>\n";
                ...
                strOutput += (Process_id.equals("PR_022"))
                        ? "<td class='forborder' width='13%'><input type='text' id='product_id_" + count + "' name = 'product_id' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "' size = 9><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_id_" + count + "', 31, '../JSP/Search_Detail.jsp')\"></a></td>\n"
                        : "<td class='forborder' width='13%'><input type='text' id='product_id_" + rs.getString("line_no") + "' name = 'product_id' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "' size = 9><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_id_" + rs.getString("line_no") + "', 31, '../JSP/Search_Detail.jsp')\"></a></td>\n";
                strOutput += (Process_id.equals("PR_022") || Process_id.equals("PR_023")|| Process_id.equals("PR_027"))
                        ...
                        + "<input type='hidden' id='location_doc_id_" + rs.getString("line_no") + "' name='location_doc_id' value = '" + objuti.NotNull(rs.getString(objprocess.Retrun_FillLocation_id())) + "'></td>\n";
                strOutput += (Process_id.equals("PR_022"))
                        ? "<td class='forborder' width='10%'><input type='text' id='warehouse_id_" + count + "' name = 'warehouse_id' value = '" + objuti.NotNull(rs.getString(objprocess.Retrun_FillWarehouse_id())) + "' size = 5 readonly><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=warehouse_id_" + count + "', 48, '../JSP/Search_Detail.jsp')\"></a></td>\n"
                        : "<td class='forborder' width='10%'><input type='text' id='warehouse_id_" + rs.getString("line_no") + "' name = 'warehouse_id' value = '" + objuti.NotNull(rs.getString(objprocess.Retrun_FillWarehouse_id())) + "' size = 5 readonly><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=warehouse_id_" + rs.getString("line_no") + "', 48, '../JSP/Search_Detail.jsp')\"></a>"
