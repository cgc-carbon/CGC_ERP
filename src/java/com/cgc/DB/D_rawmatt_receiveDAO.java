...
public class D_rawmatt_receiveDAO {
    ...
    public int update(DataBean_D_rawmatt_receive dataBean) throws Exception {
        ...
        try {
            ...
            p.setString(57, dataBean.getDoc_id());
            Returnvalue = p.executeUpdate();
