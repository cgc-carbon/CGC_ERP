...
public class D_carbon_friction_receive_headerDAO {
    ...
    public static ArrayList<DataBeanMemD_carbon_friction_receive> ObjMem_AL = new ArrayList<DataBeanMemD_carbon_friction_receive>();
    public static ArrayList<DataBeanError_Stock_Item> objError_AL = new ArrayList<DataBeanError_Stock_Item>();
