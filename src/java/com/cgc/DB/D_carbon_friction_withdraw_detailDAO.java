...
public class D_carbon_friction_withdraw_detailDAO {
    public void insert(DataBeanD_carbon_friction_withdraw_detail DataBean)throws Exception{
        ...
        try{
            ...
            p.setString(i, DataBean.getFriction_house());i += 1;
            p.setString(i, DataBean.getLocation_id());i += 1;
            p.setString(i, DataBean.getWh_in());i += 1;
            p.setString(i, DataBean.getFriction_dust_bag());i += 1;
            p.setString(i, DataBean.getFriction_dust_amount());i += 1;
            p.setString(i, DataBean.getFriction_dust_weight());i += 1;
            p.setString(i, DataBean.getPan_dust_bag());i += 1;
            p.setString(i, DataBean.getPan_dust_amount());i += 1;
            p.setString(i, DataBean.getPan_dust_weight());i += 1;
            p.setString(i, DataBean.getSucker_dust_bag());i += 1;
            p.setString(i, DataBean.getSucker_dust_amount());i += 1;
            p.setString(i, DataBean.getSucker_dust_weight());i += 1;
            p.setString(i, DataBean.getMagnet1());i += 1;
            p.setString(i, DataBean.getMagnet2());i += 1;
            p.setString(i, DataBean.getLaps_amount());i += 1;
            p.setString(i, DataBean.getLaps_weight());i += 1;
            p.setString(i, DataBean.getLaps_total());i += 1;
            p.setString(i, DataBean.getFriction_carbon_in_weight());i += 1;
            p.setString(i, DataBean.getLost_weight());i += 1;
            p.setString(i, DataBean.getCarbon_burn_in_weight());i += 1;
            p.setString(i, DataBean.getJumbo_weight());i += 1;
    ...
    public String ShowDetail(String doc_id)throws Exception{
        ...
        try{
            ...
            if(objuti.numRowdatabase("select count(doc_id) as num from vd_carbon_friction_withdraw_detail where doc_id = '"+doc_id+"' and delete_flag = 'N' and complete_flag = 'N'") == 0){
                ...
                while(rs.next()){
                    ...
                    str_return.append("<td class='forborder' width='7%'><a href=\"#\" onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",username,doc_id,doc_date','../SCREEN/CS_Detail_025_1.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\"><input type='hidden' id='doc_date' value=\"" + rs.getString("doc_date") + "\"><input type='hidden' id='runno_" + rs.getString("runno") + "'' value=\"" + rs.getString("runno") + "\">" + rs.getString("line_no") + "</a></td>");
