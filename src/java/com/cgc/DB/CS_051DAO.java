    ...
    public String showDetail(String Doc_id) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                strOutput += "<td class='forborder' width='10%'><input type='text' id='warehouse_id_" + rs.getString("line_no") + "' name = 'warehouse_id' value = '' size = 5 readonly><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=warehouse_id_" + rs.getString("line_no") + "', 48, '../JSP/Search_Detail.jsp')\"></a>"
