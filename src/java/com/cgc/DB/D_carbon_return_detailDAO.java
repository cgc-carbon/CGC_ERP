...
public class D_carbon_return_detailDAO {
    ...
    public String showDetail(String doc_id) throws Exception {
        ...
        while (rs.next()) {
            ...
            strOutput += "<td class='forborder' width='7%'><a href=\"#\" onclick=\"OpenEdit(URLsend('line_no_" + rs.getString("line_no") + ",doc_id,username','../SCREEN/CS_108.jsp'))\"><input type='hidden' id='line_no_" + rs.getString("line_no") + "' value=\"" + rs.getString("line_no") + "\"><input type='hidden' id='doc_id' value=\"" + rs.getString("doc_id") + "\">" + rs.getString("prd_no") + "</a></td>";
    ...
    public String ShowDetailApprove(String Doc_id)throws Exception{
        ...
        while (rs.next()) {
            ...
            strOutput += "<td class='forborder' width='26%'><input type = 'text' id = 'product_id_"+rs.getString("line_no")+"' name = 'product_id' value = '"+ rs.getString("c_type") +"' size = 20><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_id_"+rs.getString("line_no")+"', 31, '../JSP/Search_Detail.jsp')\"></a></td>\n";
            ...
            strOutput += "<td class='forborder' width='15%'><input type = 'text' id = 'warehouse_id_"+rs.getString("line_no")+"' name = 'warehouse_id' value = '" + objuti.NotNull(rs.getString("wh_id")) + "' size = 12><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=warehouse_id_"+rs.getString("line_no")+"', 48, '../JSP/Search_Detail.jsp')\"></a></td>\n";
