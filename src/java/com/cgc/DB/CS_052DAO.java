    ...
    public String showDetail(String Process_id, String Doc_id, String Tablename) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                strOutput += (Tablename.equals("vd_packing_product_detail_wh"))
                        ? "<td class='forborder' width='10%'>" + rs.getString(objprocess.Return_FillProduct_id()) + "<input type='hidden' id='product_doc_withdraw_" + count + "' name = 'product_doc_withdraw' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "'></td>\n"
                        : "<td class='forborder' width='10%'>" + rs.getString(objprocess.Return_FillProduct_id()) + "<input type='hidden' id='product_doc_secure_" + rs.getString("line_no") + "' name = 'product_doc_secure' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "'></td>\n";
                strOutput += "<td class='forborder' width='7%'>" + rs.getString("size_desc") + "</td>\n";
                strOutput += "<td class='forborder' width='10%'>" + rs.getString(objprocess.Return_FillWeight()) + "</td>\n";
                strOutput += (Tablename.equals("vd_packing_product_detail_wh"))
                        //? "<td class='forborder' width='13%'><input type='text' id='product_withdraw_" + rs.getString("line_no") + "' name = 'product_withdraw' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "' size = 9><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_withdraw_" + rs.getString("line_no") + "', 31, '../JSP/Search_Detail.jsp')\"></a></td>\n"
                        //: "<td class='forborder' width='13%'><input type='text' id='product_secure_" + rs.getString("line_no") + "' name = 'product_secure' value = '" + rs.getString(objprocess.Return_FillProduct_id()) + "' size = 9><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_secure_" + rs.getString("line_no") + "', 31, '../JSP/Search_Detail.jsp')\"></a></td>\n";
                        ? "<td class='forborder' width='13%'><input type='text' id='product_withdraw_" + rs.getString("line_no") + "' name = 'product_withdraw' value = '" + "" + "' size = 9><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_withdraw_" + rs.getString("line_no") + "', 31, '../JSP/Search_Detail.jsp')\"></a></td>\n"
                        : "<td class='forborder' width='13%'><input type='text' id='product_secure_" + rs.getString("line_no") + "' name = 'product_secure' value = '" + "" + "' size = 9><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_secure_" + rs.getString("line_no") + "', 31, '../JSP/Search_Detail.jsp')\"></a></td>\n";
                ...
                strOutput += (Tablename.equals("vd_packing_product_detail_wh"))
                        ? "<td class='forborder' width='10%'><input type='text' id='warehouse_withdraw_" + rs.getString("line_no") + "' name = 'warehouse_withdraw' value = '' size = 5 readonly><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=warehouse_withdraw_" + rs.getString("line_no") + "', 48, '../JSP/Search_Detail.jsp')\"></a></td>\n"
                        : "<td class='forborder' width='10%'><input type='text' id='warehouse_secure_" + rs.getString("line_no") + "' name = 'warehouse_secure' value = '' size = 5 readonly><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=warehouse_secure_" + rs.getString("line_no") + "', 48, '../JSP/Search_Detail.jsp')\"></a></td>\n";
                ...
                strOutput += (Tablename.equals("vd_packing_product_detail_wh"))
                        ? "<td class='forborder' width='10%'><input type='text' id='weight_withdraw_" + rs.getString("line_no") + "' name = 'weight_withdraw' value = '" + rs.getString(objprocess.Return_FillWeight()) + "' onKeyUp=\'IsNuber(this.value, this)\' size = 9></td>\n"
                        ...
                        : "<td class='forborder' width='10%'><input type='text' id='weight_secure_" + rs.getString("line_no") + "' name = 'weight_secure' value = '" + rs.getString(objprocess.Return_FillWeight()) + "' onKeyUp=\'IsNuber(this.value, this)\' size = 9></td>\n"
