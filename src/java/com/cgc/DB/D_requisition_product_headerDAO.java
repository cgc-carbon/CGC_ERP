...
public class D_requisition_product_headerDAO {
    ...
    public int insert(DataBeanD_requisition_product_header dataBean) throws Exception {
        ...
        try {
            ...
            p.setString(22, objuti.Count_sendcomplete("d_requisition_product_header", dataBean.getDoc_id(), dataBean.getComplete_flag(), con));
    ...
    public int update(DataBeanD_requisition_product_header dataBean) throws Exception {
        ...
        try {
            ...
            p.setString(20, objuti.Count_sendcomplete("d_requisition_product_header", dataBean.getDoc_id(), dataBean.getComplete_flag(), con));
