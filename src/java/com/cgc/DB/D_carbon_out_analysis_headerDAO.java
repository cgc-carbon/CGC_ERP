...
public class D_carbon_out_analysis_headerDAO {
    ...
    public int insert(DataBeanD_carbon_out_analysis_header DataBean, ArrayList<DataBeanD_carbon_out_analysis_detail> ObjAL_Detail) throws Exception {
        ...
        int i = 1;
        try {
            p = con.prepareStatement("insert into d_carbon_out_analysis_header(doc_id,doc_date,tdate1,tname1,ttime1,tdate2,tname2,ttime2,tdate3,tname3,ttime3,reporter_id,approve_id,approve_status,create_by,create_date,update_date) "
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            i += 1;
            p.setString(4, DataBean.getTname1());
            i += 1;
            p.setString(5, DataBean.getTtime1());
            i += 1;
            p.setString(6, DataBean.getTdate2());
            i += 1;
            p.setString(7, DataBean.getTname2());
            i += 1;
            p.setString(8, DataBean.getTtime2());
            i += 1;
            p.setString(9, DataBean.getTdate3());
            i += 1;
            p.setString(10, DataBean.getTname3());
            i += 1;
            p.setString(11, DataBean.getTtime3());
            i += 1;
            p.setString(12, DataBean.getReporter_id());
            i += 1;
            p.setString(13, DataBean.getApprove_id());
            i += 1;
            p.setString(14, DataBean.getApprove_status());
            i += 1;
            ...
            p.clearParameters();
            p = con.prepareStatement("insert into d_carbon_out_analysis_detail(doc_id,line_no,c_type1,c_type2,c_type3,bu1,bu2,bu3,avg1,avg2,avg3,create_by,create_date,update_date) "
                    + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public int update(DataBeanD_carbon_out_analysis_header DataBean) throws Exception {
        ...
        int i = 1;
        try {
            p = con.prepareStatement("update d_carbon_out_analysis_header set doc_date=?,tdate1=?,tdate2=?,tdate3=?,tname1=?,tname2=?,tname3=?,ttime1=?,ttime2=?,ttime3=?,reporter_id=?,approve_id=?,approve_status=?,update_by=?,update_date=? where doc_id = ? and delete_flag = 'N' and complete_flag = 'N'");
