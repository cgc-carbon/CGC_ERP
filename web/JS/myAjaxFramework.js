...
function openBrWindow(table, page, jsp) { //v2.0
    if (my_window == null) {
        t = '../JSP/' + jsp + '?page=' + page + '&table=' + table;
...
function gettoShow_Doc_id2(dataInput, getIdshow, URLShowDetail, DivShow, DivShow2, Valueinput)
{
    ...
    for (var i = 0; i < arryData.length; i++)
    {
        ...
        if (arryID[i] == "sale_confirm" || arryID[i] == "quality_confirm" || arryID[i] == "prod_confirm" || arryID[i] == "wh_confirm" || arryID[i] == "document_confirm_flag") {
