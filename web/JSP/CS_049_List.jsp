...
<%
            ...
            for (CarbonBurnOutBean carbonBean : list) {
                ...
                htmltext += "<tr>"
                        ...
                        + "<td width='10%' class='forborder'><input type='text' size='9' name='ctc_"+cnt+"' id='ctc_"+cnt+"' value='"+carbonBean.getCtc_i2()+"'></td>"
                        + "<td width='10%' class='forborder'><input type='text' size='5' name='product_"+cnt+"' id='product_"+cnt+"' value='"+carbonBean.getProduct_id()+"'><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_"+cnt+"', 31, '../JSP/Search_Detail.jsp')\"></a></td>"
                        + "<td width='10%' class='forborder'><input type='text' size='6' name='wh_"+cnt+"' id='wh_"+cnt+"' value='W005'><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=wh_"+cnt+"', 48, '../JSP/Search_Detail.jsp')\"></a></td>"
                        + "<td width='5%' class='forborder'><input type='text' size='3' name='location_"+cnt+"' id='location_"+cnt+"' value=''></td>"
                        + "<td width='10%' class='forborder'><input type='text' size='9' name='quantity_"+cnt+"' id='quantity_"+cnt+"' value='"+carbonBean.getWeight()+"'></td>"
