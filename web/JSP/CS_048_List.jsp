                ...
                if (!process.equals("PR_032")) {
                    ...
                    while (rs.next()) {
                        htmltext += "<tr>"
                                ...
                                + "<td class='forborder' width='13%'><input type='text' name='prod_code_" + cnt + "' id='prod_code_" + cnt + "' value='" + rs.getString("product_id") + "' size='12'/></td>"
                                + "<td class='forborder' width='7%'><input type='text' name='location_" + cnt + "' id='location_" + cnt + "' value='" + rs.getString(l) + "' size='5'/></td>"
                                + "<td class='forborder' width='9%'><input type='text' name='wh_" + cnt + "' id='wh_" + cnt + "' value='" + rs.getString(w) + "' size='8'/></td>"
                                + "<td class='forborder' width='10%'><input type='text' name='weight_" + cnt + "' id='weight_" + cnt + "' value='" + rs.getString(f) + "' size='9'/></td>";
                        if(process.equals("PR_022")){
