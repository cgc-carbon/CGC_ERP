...
<%
            ...
            for (DataBeanD_product_receive_detail_prod carbonBean : list) {
                ...
                htmltext += "<tr>"
                        ...
                        + "<td width='15%' class='forborder'><input type='text' size='10' name='product_id_" + cnt + "' id='product_id_" + cnt + "' value='" + carbonBean.getProduct_id() + "'><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('Vproduct&textinput=product_id_"+cnt+"', 31, '../JSP/Search_Detail.jsp')\"></a></td>"
                        + "<td width='10%' class='forborder'><input type='text' size='5' name='wh_" + cnt + "' id='wh_" + cnt + "' value=''><a href='#' ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle'  onclick=\"openBrWindow('mwarehouse&textinput=wh_"+cnt+"', 48, '../JSP/Search_Detail.jsp')\"></a></td>"
                        + "<td width='5%' class='forborder'><input type='text' size='2' name='location_" + cnt + "' id='location_" + cnt + "' value=''></td>"
                        + "<td width='10%' class='forborder'><input type='text' size='7' name='weigth_" + cnt + "' id='weigth_" + cnt + "' value='"+carbonBean.getWeight()+"'></td>"
