                ...
                <tr >
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <table width="100%" cellpadding="0" cellspacing="0" >
                            ...
                            %>
                            <tr>
                              <td colspan="2" align="left"><a href="javascript:;" onclick="gettoShow('<%=ptypeBean.getPtype_id()%>|<%=ptypeBean.getName_t()%>|<%=ptypeBean.getRemark()%>', 'ptype_id|name_t_ptype|remark_ptype')"><%=ptypeBean.getPtype_id()%></a></td>
