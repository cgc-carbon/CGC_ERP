                ...
                <tr >
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <table width="100%" cellpadding="0" cellspacing="0" >
                            ...
                            %>
                            <tr>
                                <td colspan="2" align="left"><a href="javascript:;"  onclick="gettoShow('<%=deptBean.getDept_id()%>|<%=deptBean.getName_t()%>|<%=deptBean.getRemark()%>', 'dept_id|dept_name|remark')"><%=deptBean.getDept_id()%></a></td>
