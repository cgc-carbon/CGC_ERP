...
<%
    ...
    if (request.getParameter("status_cal") == null) {
        ...
        if (request.getParameter("total_price") != null) {
            if (request.getParameter("total_price").equals("")) {
        ...
        if (request.getParameter("lab_not_check") != null) {
            objdb.setLab_not_check(en.EncodeTexttoTIS(request.getParameter("lab_not_check")));
        }        
