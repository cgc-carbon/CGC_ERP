...
<%
            ...
            for (DataBeanD_carbon_return_detail carbonBean : list) {
                htmltext += "<tr>"
                        ...
                        + "<td width='26%' class='forborder'><input type='text' size='25' name='product_"+cnt+"' id='product_"+cnt+"' value='"+carbonBean.getProduct_id()+"'></td>"
                        + "<td width='9%' class='forborder'>" + carbonBean.getBag_ret() + "</td>"
                        + "<td width='10%' class='forborder'>" + carbonBean.getSize() + "</td>"
                        + "<td width='10%' class='forborder'><input type='text' size='9' name='weigth_" + cnt + "' id='weigth_" + cnt + "' value='"+carbonBean.getWeight()+"'></td>"
                        + "<td width='15%' class='forborder'><input type='text' size='12' name='wh_" + cnt + "' id='wh_" + cnt + "' value=''></td>"
                        + "<td width='12%' class='forborder'><input type='text' size='10' name='location_" + cnt + "' id='location_" + cnt + "' value=''></td>"
