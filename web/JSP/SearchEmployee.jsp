                ...
                <tr >
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <table width="100%" cellpadding="0" cellspacing="0" >
                            ...
                            %>
                            <tr>
                              <td colspan="2" align="left"><a href="javascript:;" onclick="gettoShow('<%=empBean.getEmp_id()%>|<%=empBean.getFname()%>|<%=empBean.getLname()%>|<%=empBean.getRemark()%>|<%=empBean.getDept_id()%>|<%=empBean.getDept_name()%>|<%=empBean.getStatus()%>', 'emp_id|name|lname|remark_emp|dept_id|dept_name|status')"><%=empBean.getEmp_id()%></a></td>
