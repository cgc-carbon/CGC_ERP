                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    &nbsp;<a href='javascript:;' onclick="openBrWindow('Vproduct', 26, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='product_id_desc' type='text' id="product_id_desc" value='' size='30' />-->
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เลขกอง*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='location_id' type='text' id="location_id" value='<%=location_id%>' size='10' />
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ไซโล*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='silo_no' type='text' id="silo_no" value='<%=silo_no%>' size='10' readonly/><a href='#' onClick="openBrWindow('Warehouse', 26, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>
	          ...
	          <tr>
	           ...
	           -->
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='weight_balance' type='text' id="weight_balance" value='<%=weight_balance%>' size='10'  onkeyup="IsNuber(this.value, this)"/>
                                </td>
                            </tr>
