    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function AddHeader()
            {
                ...
                if(r)
                {
                    getSave(URLsend('chkNull,doc_id,doc_date,job_id,job_id_desc,cust_address_desc,cust_country_desc,po_no_desc,item_id,wh_in,wh_out,contain_no,contain_type,seal_no,palate_type,approver,approver_desc,payment_prod,payment_prod_desc,receiver,receiver_desc,car_no,net_weight,username,cust_id,return_complete_flag,document_confirm_flag','../JSP/CS_309.jsp'));
                    //cancelAction();
                    getId("status_cancle").value = "";
                    getId("child_ck").value = "";
                    getId("show").innerHTML = "";
                    ...
                    getId("doc_id").disabled = false;
                    setTimeout('getId("net_weight_chk").value = "0";getId("net_weight").value = "0";',1000);
                    getId("return_complete_flag").value = "N";getId("return_complete_flag").checked = false;
                    getId("document_confirm_flag").value = "N";getId("document_confirm_flag").checked = false;
                }
            }
            function Delete()
...
%>
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2">ใบเบิกสินค้าเพื่อส่งออก(คลังสินค้า)(CS_309)&nbsp;</td>
                ...
                <tr >
                    ...
                    <td  colspan="2" class="fcentercenter">
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        &nbsp;
                                        <a href='#' onClick="openBrWindow('vd_requisition_product_header_wh&stadment=and+complete_flag+=+\'N\'+and+doc_type+=+\'N\'', 309, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
                                        <a href='#' onClick="openBrWindow('vd_requisition_product_header_wh&stadment=and+complete_flag+=+\'N\'+and+doc_type+=+\'Y\'', 309, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
	          		วันที่เอกสาร*&nbsp;
	          		...
	          		น้ำหนักรวม(คลังสินค้า)&nbsp;
                                        <input name='net_weight_wh' type='text' id="net_weight_wh" value='0' size='10' />
                                        &nbsp;(Kg)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;น้ำหนักรวม&nbsp;
