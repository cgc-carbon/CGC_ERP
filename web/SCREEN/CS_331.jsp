                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='size' type='text' id="size" value='<%=size%>' size='10' readonly/>	 <a href='#' onClick="openBrWindow('m_carbon_size', 30, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>        	</td>
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัสยอดยกมา&nbsp;</td>
                                <td class="columnobject">
                                    <input name='g_code' type='text' id="g_code" value='<%=g_code%>' size='10' />	          	</td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ยอดยกมา&nbsp;</td>
                                <td class="columnobject">
                                    <input name='g_sum' type='text' id="g_sum" value='<%=g_sum%>' size='10' onblur="IsNuber(this.value, this)"/>	          	</td>
                            </tr>
                            <tr>
                                <td class="columnlabel">I2&nbsp;</td>
                                <td class="columnobject">
                                    <input name='ctc_i2' type='text' id="ctc_i2" value='<%=ctc_i2%>' size='10'  readonly/><a href='#' onclick="openBrWindow('m_iodine&textinput=ctc_i2', 0, '../JSP/Search_Detail.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">หน่วยบรรจุ*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='bag' type='text' id="bag" value='<%=bag%>' size='10' onkeyup="IsNumber2(this.value, this)"/>	          	</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="wh_weight" type="text" id="wh_weight" value="<%=wh_weight%>" size="10" onBlur="Weight_diff('g_sum','weight','wh_weight','weight_diff')" onkeyup="IsNuber(this.value, this)">
                                    ยอดผลต่าง
                                    <input name="weight_diff" type="text" id="weight_diff" size="10" value="<%=weight_diff%>" readonly></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัสคลัง*</td>
                                <td class="columnobject"><input name="wh_id" type="text" id="wh_id" size="10" value ="<%=wh_id%>" readonly>&nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('mwarehouse', 301, '../JSP/Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                    <input type="text" name="wh_id_desc" id="wh_id_desc"></td>
                            </tr>
                            <tr>
                        ...
                        <td class="columnobject">
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="product_id" type="text" id="product_id" value="<%=product_id%>" size="10" readonly>&nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('Vproduct', 301, '../JSP/Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                    <input type="text" name="product_id_desc" id="product_id_desc"></td>
                            </tr>
                            <tr>
