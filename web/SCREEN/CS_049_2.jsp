        ...
        <div align="center">
            <table  cellpadding="0"  cellspacing="0">
                <tr >
                    ...
                    <td  class="ftopcenter" colspan="2">อนุมัติรับถ่านออกจากเตาเข้าคลังสินค้า (คลังสินค้า)&nbsp;(CS_049_2)</td>
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        <input type='text' name='doc_id' id="doc_id" size='20' value='' />&nbsp;<a href='javascript:;' onClick="javascript:openBrWindow('vd_carbon_burn_out_header_wh&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'Y\'', 49, 'Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1'  border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="doc_date" id="doc_date" readonly> 
