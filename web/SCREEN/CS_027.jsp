...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                if(case_input == 1){
                    openBrWindow('vd_carbon_burn_in_header&stadment=and+complete_flag+=+\'N\'+and+count_send_complete+=+\'0\'', 27, '../JSP/Search_Doc_id.jsp');
                }else{
                    openBrWindow('vd_carbon_burn_in_header&stadment=and+complete_flag+=+\'N\'+and+count_send_complete+<>+\'0\'', 27, '../JSP/Search_Doc_id.jsp');
                }
                ...
                /*if(getId("date_ck").value != getId("doc_date").value || getId("child_ck").value == "1" || getId("total_weight_chk").value != getId("total_weight").value && getId("doc_id").disabled == true && getId("status_cancle").value == "1"){
                    ...
                    openBrWindow('vd_carbon_burn_in_header&stadment=and+complete_flag+=+\'N\'', 27, '../JSP/Search_Doc_id.jsp');
                }*/
            }
    ...
    <body onUnload="Unload()">
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr >
                ...
                <td  class="ftopcenter" colspan="2">ใบบันทึกถ่านเติมเตา(CS_027)&nbsp;</td>
            ...
            <tr>
                ...
                <td  colspan="2" class="fcentercenter">
                    ...
                    <input name='doc_id' type='text' id="doc_id" value='' size='15' onBlur="ChkDoc_id();"/>
                                    ...
                                    <a href='#' onClick="OpenDoc_id(2)"  ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเอกสารที่ถูกตีกลับเพื่อทำการแก้ไข' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
	          		วันที่เอกสาร*&nbsp;
