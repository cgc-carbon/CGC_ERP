        ...
        <script type="text/javascript">
            ...
            function AddHeader()
            {
                ...
                if(r)
                {
                    ...
                    //alert(strId);
                    strId = "chkNull,doc_id,doc_date,cust_id,cust_id_desc,po_no,contain_date,iso_no,country_id,country_id_desc,lot_no,mark_sign,base_plate,base_plate_desc,base_plate_qty,remark,approve,mark_sign_desc,username,quality_dep,prod_dep,wh_dep,sale_confirm,quality_confirm,prod_confirm,wh_confirm,po_no_befor,iod2,screen_id,cust_id_desc,deadline,stock_prod,maxline,"+strId;
                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="607" class="columnobject">
                                            <input name='doc_id' type='text' id="doc_id" value='' size='20' />
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            <input name='po_no' type='text' id="po_no" value='' size='20' />&nbsp;<a href='javascript:;' onClick="openBrWindow('vd_saleorderproduct_detail&stadment=and+(doc_type+<>+\'Y\'+or+doc_type+is+null)',32, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' >
                                            </a>&nbsp;&nbsp;
                                            <input name='po_no_befor' type='text' id="po_no_befor" value='' size='20' />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            ...
                                            กำหนดส่งสินค้า<input name='deadline' type='text' id="deadline" value='' size='10' readonly/>&nbsp;<a id='date_3' ><img name='IMAGE4' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField:'deadline',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_3',singleClick:true,step:1});</script>	          	</td>
                                    </tr>
                                    <tr>
                                        <td class="columnlabel">F-A-019 เลขที่*&nbsp;</td>
                                        <td class="columnobject">
                                            <input name='iso_no' type='text' id="iso_no" value='' size='20' />
                                            &nbsp;&nbsp;
                                            ประเทศ*&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            <input name='lot_no' type='text' id="lot_no" value='' size='20' />	          	</td>
                                    </tr>
                                    <tr>
                                        <td class="columnlabel">ค่า Iodine*&nbsp;</td>
                                        <td class="columnobject">
                                            <input name='iod2' type='text' id="iod2" value='' size='20' onclick="openBrWindow('m_iodine&textinput=iod2', 0, '../JSP/Search_Detail.jsp');"/>	          	</td>
                                    </tr>     
                                    <tr>
                                            ...
                                            <div  id="show" style="width:100%;">
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                    <tr>
                                                        ...
                                                        <td class="forborder" width="20%"><input name='spec1' type='text' id="spec1" value='' size=20 onclick="openBrWindow('m_carbon_size&textinput=spec1', 32, '../JSP/Search_Detail.jsp');" readonly/></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="forborder" width="20%"><input name='spec8' type='text' id="spec8" value='' size=20 onclick="openBrWindow('m_iodine&textinput=spec8', 0, '../JSP/Search_Detail.jsp');" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><textarea name='remark' cols='75' rows='5' id="remark"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td class="columnlabel">&nbsp;</td>
                                        <td class="columnobject">
