    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function OpenDoc_id()
            {
                ...
                openBrWindow('vd_rawmatt_withdraw_header&stadment=and+complete_flag+<>+\'Y\'', 23, '../JSP/Search_Doc_id.jsp');
                //}
            }
            /*function showDetail(){
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        </select><!--<input name='p_type' type='text' id="p_type" value='' size='10' readonly="readonly" />
                                        &nbsp;&nbsp;<a href='#' onClick="javascript:openBrWindow('Mproduct_type', 23, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='p_type_desc' type='text' id="p_type_desc" value='' size='30' readonly="readonly" />--></td>
                                </tr>
                                <tr>
