                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    &nbsp;<a href='#' onclick="javascript:openBrWindow('Vproduct', 39, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='product_id_desc' type='text' id="product_id_desc" value='<%=prod_name%>' size='30' readonly="readonly"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">แหล่งผลิต*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='place_prd' type='text' id="place_prd" value='<%=place_prd%>' size='30' />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='palate_no' type='text' id="palate_no" value='<%=palate_no%>' size='10' />
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">จำนวนที่ใช้*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='qty_use' type='text' id="qty_use" value='<%=qty_use%>' size='10' />
                                    &nbsp;(กิโลกรัม)
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='qty_balance' type='text' id="qty_balance" value='<%=qty_balance%>' size='10' />
                                    &nbsp;(กิโลกรัม)
                                </td>
                            </tr>
                            <tr>
