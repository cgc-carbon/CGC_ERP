                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    &nbsp;<a href='#' onClick="javascript:openBrWindow('Vproduct&&stadment=and+ptype_code+=+\'2\'', 43, '../JSP/Search_Config2.jsp')" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='product_id_desc' type='text' id="product_id_desc" value='<%=prod_name%>' size='30' readonly="readonly"/>                                </td>
                            </tr>
                            <tr>
                              ...
                              &nbsp;<a href='#' onClick="openBrWindow('Vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'', 43, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='job_id_desc' type='text' id="job_id_desc" value='<%=job_id_desc%>' size='30' readonly="readonly"/>
