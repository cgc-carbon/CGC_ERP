        ...
        <script type="text/javascript">
            ...
            function Opendoc_id(input)
            {
                switch(input){
                    case 1:
                        if(getId("select_mbranch").value == "not"){
                            //openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'Y\'+and+price_flag+=+\'N\'', 223, '../JSP/Search_Config2.jsp');
                            openBrWindow('Vd_rawmatt_receive&stadment=and+doc_type+=+\'Y\'+and+price_flag+=+\'N\'', 223, '../JSP/Search_Config2.jsp');
                        }else{
                            //openBrWindow("Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'Y\'+and+price_flag+=+\'N\'+and+location_id2+=+\'"+getId("select_mbranch").value+"\'", 223, '../JSP/Search_Config2.jsp');
                            openBrWindow("Vd_rawmatt_receive&stadment=and+doc_type+=+\'Y\'+and+price_flag+=+\'N\'+and+location_id2+=+\'"+getId("select_mbranch").value+"\'", 223, '../JSP/Search_Config2.jsp');                            
                        }
                        break;
                    case 2:
                        if(getId("select_mbranch").value == "not"){
                            //openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'Y\'+and+price_flag+=+\'Y\'', 223, '../JSP/Search_Config2.jsp');
                            openBrWindow('Vd_rawmatt_receive&stadment=and+doc_type+=+\'Y\'+and+price_flag+=+\'Y\'', 223, '../JSP/Search_Config2.jsp');
                        }else{
                            //openBrWindow("Vd_rawmatt_receive&stadment=and+complete_flag+<>+\'Y\'+and+doc_type+=+\'Y\'+and+price_flag+=+\'Y\'+and+location_id2+=+\'"+getId("select_mbranch").value+"\'", 223, '../JSP/Search_Config2.jsp');
                            openBrWindow("Vd_rawmatt_receive&stadment=and+doc_type+=+\'Y\'+and+price_flag+=+\'Y\'+and+location_id2+=+\'"+getId("select_mbranch").value+"\'", 223, '../JSP/Search_Config2.jsp');
                        }
                        break;
                    default:
                        break;
                        ...
                        <div align="left">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="columnobject">
                                        <input name='position_no' type='text' id="position_no" readonly="readonly" value='' size='10' />	          	</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="columnobject"><input name="car_date_in" type="text" id="car_date_in" size="10" readonly><a id='date_2'><img name='IMAGE2' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField:'car_date_in',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_2',singleClick:true,step:1});</script>
                                        เลขที่ใบชั่งถ่าน*&nbsp;
                                        <input name='scale_no' type='text' id="scale_no" readonly="readonly" value='' size='10' /></td>
                                </tr>
                                <tr>
                                    <td class="columnlabel"><span class="columnobject">เลขทะเบียนรถ*</span></td>
                                    <td colspan="3" class="columnobject"><input name='car_no' type='text' id="car_no" readonly="readonly" value='' size='10' />
                                        &nbsp;&nbsp;
                                        ชื่อคนขับ*&nbsp;
                                        <input name='driver_name' type='text' id="driver_name" readonly="readonly" value='' size='20' /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="columnobject"><input name="car_cbag_weight" type="text" id="car_cbag_weight" readonly="readonly" size="10" onKeyUp="IsNuber(this.value, this)" onBlur="cal_total_weight()">
                                        &nbsp;กิโลกรัม                            </tr>
                                <tr>
                                    <td class="columnlabel">น.น.รถ</td>
                                    <td colspan="3" class="columnobject"><input name="car_weight" type="text" id="car_weight" readonly="readonly" size="10" onKeyUp="IsNuber(this.value, this)" onBlur="cal_total_weight()">
                                        &nbsp;กิโลกรัม                             </tr>
                                <tr>
                                    <td class="columnlabel">น.น.กระสอบ</td>
                                    <td colspan="3" class="columnobject"><input name='bag_weight' type='text' id="bag_weight" value='' readonly="readonly" size='10' onKeyUp="IsNuber(this.value, this)" onBlur="cal_bag_net()"/>
                                        &nbsp;น.น.กระสอบ/ใบ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวนกระสอบ&nbsp;
                                        <input name="bag_total" type="text" id="bag_total" readonly="readonly" size="10" onKeyUp="IsNumber2(this.value, this)" onBlur="cal_bag_net()">
                                        ใบ</tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="314" class="columnobject">%ตามข้อกำหนด&nbsp;คำนวณ(ความชื้น+การระเหย<24)<input type="checkbox" id="new_cal" name="new_cal" value="N" onClick="New_Cal(this.checked)"></td>
                                </tr>
                                <tr>
...
<!--- Add for Account -->
                                <tr>
                                    ...
                                    <td class="columnobject">                                        
                                        &nbsp;&nbsp;                                        
                                        &nbsp;</td>
                                    <td class="columnobject"><div align="right"><span class="columnlabel"></span></div></td>
                                    <td class="columnobject">
                                        &nbsp;&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">                                        
                                        ...
                                        &nbsp;</td>
                                    <td class="columnobject"><div align="right"><span class="columnlabel">ขี้เถ้า%</span></div></td>
                                    <td class="columnobject"><input name='ashes_percent_acc' type='text' id="ashes_percent_acc" value='' size='5' onKeyUp="IsNuber(this.value, this)" onBlur="javascript:Calculator_ch('ashes_percent','ashes_percent_acc','ashes_weight_acc','total_weight','bag_weight');" />
                                        &nbsp;&nbsp;
                                        <input name='ashes_weight_acc' type='text' id="ashes_weight_acc" value='' size='10' readonly ="readonly"/>
                                        &nbsp;กิโลกรัม</td>
                                </tr>
                                <tr>
                                    <td class="columnlabel"></td>
                                    <td class="columnobject">                                        
                                        &nbsp;&nbsp;&nbsp;</td>
                                    <td class="columnobject"><div align="right"><span class="columnlabel">ฝุ่น%&nbsp;</span></div></td>
                                    <td class="columnobject"><input name='dust_percent_acc' type='text' id="dust_percent_acc" value='' size='5' onKeyUp="IsNuber(this.value, this)" onBlur="javascript:Calculator_ch('dust_percent','dust_percent_acc','dust_weight_acc','total_weight','bag_weight');"/>
                                        &nbsp;&nbsp;
                                        <input name='dust_weight_acc' type='text' id="dust_weight_acc" value='' size='10' readonly ="readonly"/>
                                        &nbsp;กิโลกรัม</td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">&nbsp;</td>
                                    <td class="columnobject">                                       
                                        &nbsp;&nbsp;&nbsp;</td>
                                    <td class="columnobject"><div align="right"><span class="columnlabel">การระเหย%&nbsp;</span></div></td>
                                    <td class="columnobject"><input name='volatile_percent_acc' type='text' id="volatile_percent_acc" value='' size='5' onKeyUp="IsNuber(this.value, this)" onBlur="javascript:Calculator_ch('volatile_percent','volatile_percent_acc','volatile_weight_acc','total_weight','bag_weight');"/>
                                        &nbsp;&nbsp;
                                        <input name='volatile_weight_acc' type='text' id="volatile_weight_acc" value='' size='10' readonly ="readonly"/>
                                      &nbsp;กิโลกรัม </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">&nbsp;</td>
                                    ...
                                    <td class="columnobject"><div align="right"><span class="columnlabel">ความชื้นเฉลี่ย%&nbsp;</span></div></td>
                                    <td class="columnobject"><input name='moise_percent_acc' type='text' id="moise_percent_acc" value='' size='5' onKeyUp="IsNuber(this.value, this)" onBlur="javascript:Calculator_ch('moise_percent','moise_percent_acc','moise_weight_acc','total_weight','bag_weight');"/>
                                        &nbsp;&nbsp;
                                        <input name='moise_weight_acc' type='text' id="moise_weight_acc" value='' size='10' readonly ="readonly"/>
                                        &nbsp;กิโลกรัม </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">&nbsp;</td>
                                    <td class="columnobject">&nbsp;&nbsp;&nbsp;</td>
                                    <td class="columnobject"><div align="right">สิ่งเจือปน%</div></td>
                                    <td class="columnobject"><input name='contamination_percent_acc' type='text' id="contamination_percent_acc" value='' size='5' onKeyUp="IsNuber(this.value, this)"  onBlur="javascript:Calculator_ch('contamination_percent','contamination_percent_acc','contamination_weight_acc','total_weight','bag_weight');"/>
                                        &nbsp;&nbsp;
                                        <input name='contamination_weight_acc' type='text' id="contamination_weight_acc" value='' size='10' readonly ="readonly"/>
                                        &nbsp;กิโลกรัม </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">&nbsp;</td>
                                    ...
                                    <td class="columnobject"><div align="right"><span class="columnlabel">น้ำหนักสุทธิ(จ่ายเงิน)&nbsp;</span></div></td>
                                    <td class="columnobject"><input name='net_weight_acc' type='text' id="net_weight_acc" value='' size='10' />
                                        &nbsp;กิโลกรัม <!--<input type="checkbox" id="new_cal" name="new_cal" value="N" onclick="New_Cal(this.checked)">--></td>
                                </tr>
