        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr>
                ...
                <td  class="ftopcenter" colspan="2"><DIV id="u4_rtf">
                        <DIV id="u4_rtf2">
                            <DIV id="u9_rtf">
                                <DIV id="u4_rtf3">ยืนยันแจ้งคืนถ่านกัมมันต์ที่เหลือจากการผลิตเข้าคลังสินค้า (CS_114)</DIV>
                            </DIV>
                        </DIV>
                    </DIV></td>
            ...
            <tr >
                ...
                <td  colspan="2" class="fcentercenter"><div align="center">
                        <table width="94%"  cellpadding="0" cellspacing="0" >
                            ...
                            <td width="200" align=""
                                class="columnlabel">&nbsp;</td>
                            <td width="556" class="columnobject"><b>เลขที่เอกสาร*</b>
                                <input name='doc_id' type='text' id="doc_id" value='' size='10' />
                                &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_carbon_return_header_wh&stadment=and+complete_flag+<>+\'Y\'', 114, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
