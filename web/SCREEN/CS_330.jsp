                            ...
                            <table   cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td width="607" class="columnobject">
                                        ...
                                        &nbsp;
                                        <a href='#' onClick="openBrWindow('vd_carbon_burn_out_header_wh&stadment=and+complete_flag+=+\'Y\'', 300, '../JSP/Search_Doc_id.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        วันที่เอกสาร*&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        <input name='work_date' type='text' id="work_date" value='' size='10' readonly="readonly"/><!--
                                      &nbsp;<a id='date_2' ><img name='IMAGE3' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField:'work_date',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_2',singleClick:true,step:1});</script>-->&nbsp;&nbsp;&nbsp;
                                        เวลา&nbsp;
                                        <input name='time_from' type='text' id="time_from" value='' size='10' maxlength="5" readonly />
                                        &nbsp;&nbsp;
                                        ถึง&nbsp;&nbsp;
                                        <input name='time_to' type='text' id="time_to" value='' size='10' maxlength="5" readonly/>	            </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">ผู้บันทึก&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='runner_id' type='text' id="runner_id" value='' size='10' readonly="readonly" /><!--
                                        &nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('Vemployee&stadment=and+dept_id+=+\'002\'', 29, '../JSP/Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;--><input name='runner_id_desc' type='text' id="runner_id_desc" value='' size='30' readonly="readonly"/>	          	</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        <a href='#' onClick="openBrWindow('Wh_en', 23, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>-->
                                    </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">ถ่านจากเตา&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='burn_no' type='text' id="burn_no" value='' size='10' readonly/>
                                        &nbsp;&nbsp;
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href='#' onClick="openBrWindow('Vproduct', 29, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE5' width='20' height='20' border='0' align='middle' ></a>
                                  <input name='product_id_desc' type='text' id="product_id_desc" value='' size='20' readonly="readonly"/>-->	          	</td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">ช่องที่*&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='ch_from' type='text' id="ch_from" value='' size='10' readonly />
                                        &nbsp;&nbsp;
                                        ถึง*&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input name='ch_to' type='text' id="ch_to" value='' size='10' readonly/>	          	</td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">น้ำหนักก่อนร่อนแยก*&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='weight_split' type='text' id="weight_split" value='' size='10' readonly/>
                                        &nbsp;&nbsp;
                                        วันที่*&nbsp;
                                        <input type='text' name='burn_out_date' id="burn_out_date" size='10' value='' readonly="readonly"/>
                                        &nbsp;<!--<a id='date_3' ><img name='IMAGE6' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a>
                                ...
                                <tr>
                                    <td colspan="2" align="right">
                                        ผู้รายงาน
                                        <input name="report_id" type="text" id="report_id" size="10" readonly>
                                        <!--<a href='#' onClick="openBrWindow('Vemployee1', 29, '../JSP/Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>-->
                                        <input name="report_id_desc" type="text" id="report_id_desc" size="20" readonly>
                                        &nbsp;&nbsp;&nbsp;&nbsp;สูญเสีย*&nbsp;
                                        <input name='lost_weight' type='text' id="lost_weight" value='0' size='10' readonly="readonly" />
