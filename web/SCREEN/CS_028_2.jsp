                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='silo_no' type='text' id="silo_no" value='<%=silo_no%>' size='10' readonly/><a href='#' onClick="openBrWindow('Warehouse', 28, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>                              <input name='silo_desc' type='hidden' id="silo_desc" value='' size='30' />  </td>
                            </tr>
                            <tr>
