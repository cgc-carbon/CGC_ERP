        ...
        <td  colspan="2" class="fcentercenter"><div align="center">
            <table width="94%"  cellpadding="0" cellspacing="0" >
              ...
              <tr>
                ...
                <td width="600" class="columnobject"><input type='text' name='doc_id2' size='10' value='' />
                  &nbsp;<a href='javascript:;'><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                  วันที่เอกสาร*&nbsp;
                  ...
                  &nbsp; เวลา*
                  <input type='text' name='doc_date2' size='10' value='' /></td>
              </tr>
              <tr>
                <td class="columnlabel">แผนก*&nbsp;</td>
                <td class="columnobject"><input type='text' name='prd_emp_id' size='' value='' />
                  <a href='javascript:;'><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;<input type='text' name='input2' size='' value='' /></td>
              </tr>
              ...
              <tr>
                <td colspan="2" align="center"><div align="right"><span class="columnobject">ผู้นำส่ง*
                      <input type='text' name='input' size='10' value='' />
&nbsp;<a href='javascript:;')><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
<input type='text' name='input' size='30' value='' />
                </span></div></td>
              </tr>
              <tr>
                <td colspan='2' class='blankspace'></td>
