                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        &nbsp;<a href='#' onClick="javascript:openBrWindow('d_adjust_product_header&stadment=and+complete_flag+<>+\'Y\'', 115, 'Search_Doc_id.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                        วันที่เอกสาร*&nbsp;
                                ...
                                <!--<tr>
                                    ...
                                    <td class="columnobject"><input type="text" size="10" id="wh_in" name="wh_in" value="" ><a href='#' onClick="openBrWindow('Wh_bg', 23, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a> 
                                            ...
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    ...
                                                    <td colspan="6" class="btn_multi">
                                                        <input type='button' class="cgcButton_4" name='but1' value='  เพิ่ม  ' onClick="goAddChild(URLsend('doc_id,doc_date,status_a,username', 'CS_116.jsp'))"/>
