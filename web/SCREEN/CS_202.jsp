    ...
    <body onUnload="closepopup()">
        ...
        <table  cellpadding="0"  cellspacing="0">
            <tr >
                ...
                <td  class="ftopcenter" colspan="2">ทะเบียนขนาดถ่าน (CS_202)</td>
                ...
                <td  colspan="2" class="fcentercenter">
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                <td class="columnlabel"><b>รหัสขนาดถ่าน</b>&nbsp;</td>
                                <td class="columnobject">
                                    <input type='text' name='size_id' size='10' value='' id="size_id" />
                                    &nbsp;<a href='javascript:;' onClick="openBrWindow('vm_carbon_size',202,'Serch_Config.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
