                            ...
                            <table width="94%"  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td width="600" class="columnobject"><input name='doc_id' type='text' id="doc_id" value='' size='10' />
                                        &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_carbon_return_header&stadment=and+complete_flag+<>+\'Y\'+and+count_send_complete+=+\'0\'', 103, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                        <a href='#' title="ค้นหาข้อมูลที่ทำเบิกที่กลับมาแก้ไข"  onClick="openBrWindow('vd_carbon_return_header&stadment=and+complete_flag+<>+\'Y\'+and+count_send_complete+<>+\'0\'', 103, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาข้อมูลที่ทำเบิกที่กลับมาแก้ไข' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        วันที่เอกสาร*&nbsp;
                                ...
                                <tr>
                                    <td colspan="2" align="center"><div align="right"><span class="columnobject">ผู้นำส่ง*
                                                ...
                                                <input name='sending_id_desc' type='text' id="sending_id_desc" value='' size='30' readonly/>
                                                &nbsp;&nbsp;</span></div></td>
                                </tr>
                                <tr>
