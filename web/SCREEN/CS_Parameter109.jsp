                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            <tr>
                                ...
                                <td class="columnobject"><input type='text' name='bag' size='20' id="bag"  value="<%=bag%>" /></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">แหล่งผลิต*</td>
                                <td class="columnobject"><input name="prd_place" type="text" id="prd_place" size="20" value="<%=prd_place%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ขนาด/ชนิดถ่าน*</td>
                                <td class="columnobject"><input name="c_type" type="text" id="c_type" size="20" value="<%=c_type%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัส*</td>
                                <td class="columnobject"><input name="prd_code" type="text" id="prd_code" size="20" value="<%=prd_code%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">H2O(%)*</td>
                                <td class="columnobject"><input name="h2o" type="text" id="h2o" size="20" value="<%=h2o%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">Butane(%)*</td>
                                <td class="columnobject"><input name="ba" type="text" id="ba" size="20" value="<%=ba%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ไอโอดีน(mg/g)*</td>
                                <td class="columnobject"><input name="iod" type="text" id="iod" size="20" value="<%=iod%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เลขที่ใบแจ้งการผลิต</td>
                                <td class="columnobject"><input name="job_id" type="text" id="job_id" value="<%=job_id%>" size="20"><a href='javascript:;' onClick="openBrWindow('vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'', 109, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                    <input name="job_id_desc" type="text" id="job_id_desc" value ="<%=job_id_desc%>"size="30">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="columnobject"><table width="100%" border="0" id="tbExp">
                                        ...
                                        <tr>
                                            <td class="columnobject"><input name="hd1" type="text" id="hd1" size="4" value="<%=hd1%>"></td>
                                            <td class="columnobject"><input name="hd2" type="text" id="hd2" size="4" value="<%=hd2%>"></td>
                                            <td class="columnobject"><input name="hd3" type="text" id="hd3" size="4" value="<%=hd3%>"></td>
                                            <td class="columnobject"><input name="hd4" type="text" id="hd4" size="4" value="<%=hd4%>"></td>
                                            <td class="columnobject"><input name="hd5" type="text" id="hd5" size="4" value="<%=hd5%>"></td>
                                            <td class="columnobject"><input name="hd6" type="text" id="hd6" size="4" value="<%=hd6%>"></td>
                                            <td class="columnobject"><input name="hd7" type="text" id="hd7" size="4" value="<%=hd7%>"></td>
                                            <td class="columnobject"><input name="hd8" type="text" id="hd8" size="4" value="<%=hd8%>"></td>
                                            <td class="columnobject"><input name="hd9" type="text" id="hd9" size="4" value="<%=hd9%>"></td>
                                            <td class="columnobject"><input name="hd10" type="text" id="hd10" size="4" value="<%=hd10%>"></td>
                                            <td class="columnobject"><input name="hd11" type="text" id="hd11" size="4" value="<%=hd11%>"></td>
                                            <td class="columnobject"><input name="hd12" type="text" id="hd12" size="4" value="<%=hd12%>"></td>
                                            <td class="columnobject"><input name="hd13" type="text" id="hd13" size="4" value="<%=hd13%>"></td>
                                            <td class="columnobject"><input name="hd14" type="text" id="hd14" size="4" value="<%=hd14%>"></td>
                                            <td class="columnobject"><input name="hd15" type="text" id="hd15" size="4" value="<%=hd15%>"></td>
                                        </tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="grade" type="text" id="grade" size="20" value="<%=grade%>"></td>
                            </tr>
                            <tr>
