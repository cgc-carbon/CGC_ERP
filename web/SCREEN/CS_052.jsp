            ...
            <div align="center">
                ...
                <table  cellpadding="0"  cellspacing="0">
                    <tr >
                        ...
                        <td  class="ftopcenter" colspan="2">อนุมัติการบรรจุถ่านกำมันต์ (คลังสินค้า)&nbsp;(CS_052)</td>
                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <!--<tr>
                                        ...
                                        <td class="columnobject">รหัส process*
                                            <input type='text' name='process_id' id="process_id" size='10' value='' />
                                        ...
                                        <td colspan="2" align="center">
                                            <div width="100%">
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner3">
                                                    ...
                                                    <tr>
                                                        <td class="row3" width="3%"><input name="chk_all2" type="checkbox" id="chk_all2" onClick="ckall2(this.checked);" value="chk_all"/></td>
                                                        <td class="row3" width="3%">No.&nbsp;</td>
                                                        <td class="row3" width="10%">เลขที่เอกสาร&nbsp;</td>
                                                        <td class="row3" width="7%">วันที่เอกสาร&nbsp;</td>
                                                        <td class="row3" width="10%">ใบแจ้งผลิต&nbsp;</td>
