                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input type='text' name='prd_no' size='10' id="prd_no" readonly="readonly" value="<%=prd_no%>" />
                                    &nbsp;<a href='#'onclick="javascript:openBrWindow('Vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'', 108, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle'  ></a>&nbsp;&nbsp;&nbsp;<input type='text' name='prd_no_desc' size='30' id="prd_no_desc"  readonly="readonly" value="<%=prd_no_desc%>"/>                                </td>
                            </tr>
                            <tr>
                                <td height="28" class="columnlabel">ขนาด*&nbsp;</td>
                                <td class="columnobject"><input name="size" type="text" id="size" size="10" value="<%=size%>">&nbsp;<a onclick="openBrWindow('m_carbon_size&textinput=size', 32, '../JSP/Search_Detail.jsp');" href="#">
                                        <img align="middle" border="0" width="20" height="20" name="IMAGE3" alt="ค้นหา" src="../IMAGES/BUTTON/MAIN/SEARCH20.gif">
                                    </a></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ชนิดของถ่าน*&nbsp;</td>
                                <td class="columnobject"><input name="c_type" type="text" id="c_type" size="10" value="<%=c_type%>">
                                    <a href='#'onclick="javascript:openBrWindow('Mproduct_cat', 108, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle'  ></a>
                                    <input type='text' name='c_type_desc' size='30' id="c_type_desc"  readonly="readonly" value="<%=c_type_desc%>"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ไอโอดีน*&nbsp;</td>
                                <td class="columnobject"><input name="iod" type="text" id="iod" size="20" value="<%=iod%>"  readonly><a href='#' onclick="openBrWindow('m_iodine&stadment=and+iod_ctype+=+\''+getId('c_type').value+'\'&textinput=iod', 0, '../JSP/Search_Detail.jsp')" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle'  ></a></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัสครบพาเลท/ครบถุง*&nbsp;</td>
                                <td class="columnobject"><input name="comp_palate" type="text" id="comp_palate" size="20" value="<%=comp_palate%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เลขที่/ถุงที่*&nbsp;</td>
                                <td class="columnobject"><input name="late_no" type="text" id="late_no" size="20" value="<%=late_no%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เครื่องผลิต*&nbsp;</td>
                                <td class="columnobject"><input name="machine" type="text" id="machine" size="20" value="<%=machine%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ขนาดบรรจุ*&nbsp;</td>
                                <td class="columnobject"><input name="size_cont" type="text" id="size_cont" size="20" value="<%=size_cont%>" onKeyUp="IsNuber(this.value, this)"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">จำนวนคืน*&nbsp;</td>
                                <td class="columnobject">กระสอบ/ถุง*&nbsp;
                                    <input name="bag" type="text" id="bag" size="10" value="<%=bag%>" onKeyUp="IsNuber(this.value, this)">
                                    &nbsp;&nbsp;น้ำหนักถุงเศษ*&nbsp;
                                    <input name="s_weight" type="text" id="s_weight" size="10" value="<%=s_weight%>" onKeyUp="IsNuber(this.value, this)">
                                    &nbsp;&nbsp;น้ำหนักสุทธินำส่ง*&nbsp;
                                    <input name="weight" type="text" id="weight" size="10" value="<%=weight%>" onKeyUp="IsNuber(this.value, this)">
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">สาเหตุการคืน*&nbsp;</td>
                                <td class="columnobject">
                                    <input type='text' name='reason_ret' size='40' id="reason_ret" value="<%=reason_ret%>"/>                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">หมายเหตุ&nbsp;</td>
                                <td class="columnobject"><label>
                                        <textarea name="remark" id="remark" cols="45" rows="5"><%=remark%></textarea>
                                    </label></td>
                            </tr>
