                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">รหัส process* 
                                            <input type='text' name='process_id' id="process_id" size='10' value='' />&nbsp;<a href='javascript:;' onclick="openBrWindow('vmprocess&stadment=and+doc_type+<>+\'N\'', 48, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                            <input type='text' name='name_t' size='30' value='' />
