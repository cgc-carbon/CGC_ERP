...
<html>
    ...
    <head>
        ...
        function OpenDoc_id()
        {
            ...
            openBrWindow('vd_carbon_friction_receive_header&stadment=and+complete_flag+<>+\'Y\'', 25, '../JSP/Search_Doc_id.jsp');
            //}
        }
                    ...
                    <tr >
                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            <input name='doc_id' type='text' id="doc_id" value='' size='17' />
                                            &nbsp;<a href='javascript:;' onClick="OpenDoc_id();"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
	          		วันที่เอกสาร*&nbsp;
	          		...
	          		ถึง&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            <input name='runner_id' type='text' id="runner_id" value='' size='10' />
                                            &nbsp;<a href='javascript:;' onClick="openBrWindow('Vemployee', 25, '../JSP/Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>
                                            <input name='runner_id_desc' type='text' id="runner_id_desc" value='' size='30' />	          	</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            ...
                                            <a href='#' onClick="openBrWindow('Wh_en&stadment=and+warehouse_id+=+\'<%=objs_p.getWarehouse_end_id()%>\'', 23, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>
                                        ...
                                        <td rowspan="8" class="columnobject"><table width="200" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td colspan="6">การบรรจุถ่านวัตถุดิบจากไซโลใส่ถุงจัมโบ้รวม &nbsp;
                                                        <input name='loc_total' type='text' id="loc_total" value='' size='10' onkeypress="" onblur="IsNumber2(this.value, this);Clear_Value(this.value);"/>
                                                        กอง</td>
                                                </tr>
                                                <tr>
                                                    <td width="11%"><input name='loc_1' type='text' id="loc_1" value='' size='10' /></td>
                                                    <td width="17%"><div align="right">บรรจุกระสอบขนาด</div></td>
                                                    <td width="19%"><input name='s_bag_loc1' type='text' id="s_bag_loc1" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        kg.</td>
                                                    <td width="15%"><div align="right">จำนวน </div></td>
                                                    <td width="13%"><div align="left">
                                                            <input name='q_bag_loc1' type='text' id="q_bag_loc1" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        </div></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name='w_bag_loc1' type='text' id="w_bag_loc1" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        kg.</td>
                                                    <td><div align="right">สถานที่จัดเก็บ</div></td>
                                                    <td>
                                                        <div align="left">
                                                            <input name='loc_1_desc' type='text' id="loc_1_desc" value='' size='7' readonly/>
                                                            <input name='loc_1_name' type='hidden' id="loc_1_name" value='' size='7' />
                                                        </div></td>
                                                    <td><a href='#' onClick="openBrWindow('Warehouse', 25, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a></td>
                                                </tr>
                                                <tr>
                                                    <td><input name='loc_2' type='text' id="loc_2" value='' size='10' /></td>
                                                    <td><div align="right">บรรจุกระสอบขนาด</div></td>
                                                    <td><input name='s_bag_loc2' type='text' id="s_bag_loc2" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        kg.</td>
                                                    <td><div align="right">จำนวน </div></td>
                                                    <td>
                                                        <div align="left">
                                                            <input name='q_bag_loc2' type='text' id="q_bag_loc2" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        </div></td>
                                                    <td>กระสอบ</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td><div align="right">น้ำหนักรวม</div></td>
                                                    <td><input name='w_bag_loc2' type='text' id="w_bag_loc2" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        kg.</td>
                                                    <td><div align="right">สถานที่จัดเก็บ</div></td>
                                                    <td>
                                                        <div align="left">
                                                            <input name='loc_2_desc' type='text' id="loc_2_desc" value='' size='7' readonly/>
                                                            <input name='loc_2_name' type='hidden' id="loc_2_name" value='' size='7' />
                                                        </div></td>
                                                    <td><a href='#' onClick="openBrWindow('Warehouse1', 25, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a></td>
                                                </tr>
                                                <tr>
                                                    <td><input name='loc_3' type='text' id="loc_3" value='' size='10' /></td>
                                                    <td><div align="right">บรรจุกระสอบขนาด</div></td>
                                                    <td><input name='s_bag_loc3' type='text' id="s_bag_loc3" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        kg.</td>
                                                    <td><div align="right">จำนวน </div></td>
                                                    <td>
                                                        <div align="left">
                                                            <input name='q_bag_loc3' type='text' id="q_bag_loc3" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        </div></td>
                                                    <td> กระสอบ</td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td><div align="right">น้ำหนักรวม</div></td>
                                                    <td><input name='w_bag_loc3' type='text' id="w_bag_loc3" value='' size='7' onBlur="IsNuber(this.value, this);"/>
                                                        kg.</td>
                                                    <td><div align="right">สถานที่จัดเก็บ</div></td>
                                                    <td>
                                                        <div align="left">
                                                            <input name='loc_3_desc' type='text' id="loc_3_desc" value='' size='7' readonly/>
                                                            <input name='loc_3_name' type='hidden' id="loc_3_name" value='' size='7' />
                                                        </div></td>
                                                    <td><a href='#' onClick="openBrWindow('Warehouse2', 25, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a></td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><table width="92%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="17%"><input name='c_bag_qty' type='text' id="c_bag_qty" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_c_weight()"/>
                                                        ถุง&nbsp;&nbsp;                                                       
                                                        <input name='c_bag_weight' type='text' id="c_bag_weight" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_c_weight()" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kg.</td>
                                                    <td width="17%"><div align="right">P : ปาล์ม ฝุ่นสี : จำนวน</div></td>
                                                    <td width="17%"><input name='p_bag_qty' type='text' id="p_bag_qty" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_p_weight()"/>
                                                        ถุง&nbsp;&nbsp;
                                                        <input name='p_bag_weight' type='text' id="p_bag_weight" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_p_weight()"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kg.</td>
                                                    <td width="16%"><div align="right">U : ยูคาฯ  ฝุ่นสี : จำนวน</div></td>
                                                    <td width="17%"><input name='u_bag_qty' type='text' id="u_bag_qty" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_u_weight()"/>
                                                        ถุง&nbsp;&nbsp;
                                                        <input name='u_bag_weight' type='text' id="u_bag_weight" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_u_weight()"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kg.</td> 
                                                </tr> 
                                                <tr>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="17%"><input name='c_weight1' type='text' id="c_weight1" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.                                                       
                                                        <input name='loc_c1' type='text' id="loc_c1" value='' size='3' /></td>
                                                    <td width="17%"><div align="right">P : ปาล์ม ฝุ่นสี : </div></td>
                                                    <td width="17%"><input name='p_weight1' type='text' id="p_weight1" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_p1' type='text' id="loc_p1" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                    <td width="16%"><div align="right">U : ยูคาฯ  ฝุ่นสี&nbsp;</div></td>
                                                    <td width="17%"><input name='u_weight1' type='text' id="u_weight1" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_u1' type='text' id="loc_u1" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                </tr>
                                                <tr>
                                                    <td><div align="right">ฝุ่นเครี่องดูดฝุ่น&nbsp;</div></td>
                                                    <td><input name='c_weight2' type='text' id="c_weight2" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_c2' type='text' id="loc_c2" value='' size='3' /></td>
                                                    <td><div align="right">ฝุ่นเครี่องดูดฝุ่น&nbsp;</div></td>
                                                    <td><input name='p_weight2' type='text' id="p_weight2" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_p2' type='text' id="loc_p2" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                    <td><div align="right">ฝุ่นเครี่องดูดฝุ่น&nbsp;</div></td>
                                                    <td><input name='u_weight2' type='text' id="u_weight2" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_u2' type='text' id="loc_u2" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                </tr>
                                                <tr>
                                                    <td><div align="right">จำนวนสี  &nbsp;</div></td>
                                                    <td><input name='c_weight3' type='text' id="c_weight3" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_c3' type='text' id="loc_c3" value='' size='3' /></td>
                                                    <td><div align="right">จำนวนสี  &nbsp;</div></td>
                                                    <td><input name='p_weight3' type='text' id="p_weight3" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_p3' type='text' id="loc_p3" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                    <td><div align="right">จำนวนสี  &nbsp;</div></td>
                                                    <td><input name='u_weight3' type='text' id="u_weight3" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_u3' type='text' id="loc_u3" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                </tr>
                                                <tr>
                                                    <td><div align="right">แม่เหล็ก 1นน.&nbsp;</div></td>
                                                    <td><input name='c_weight4' type='text' id="c_weight4" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_c4' type='text' id="loc_c4" value='' size='3' /></td>
                                                    <td><div align="right">แม่เหล็ก 1นน.&nbsp;</div></td>
                                                    <td><input name='p_weight4' type='text' id="p_weight4" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_p4' type='text' id="loc_p4" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                    <td><div align="right">แม่เหล็ก 1นน.&nbsp;</div></td>
                                                    <td><input name='u_weight4' type='text' id="u_weight4" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_u4' type='text' id="loc_u4" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                </tr>
                                                <tr>
                                                    <td><div align="right">แม่เหล็ก 2นน.&nbsp;</div></td>
                                                    <td><input name='c_weight5' type='text' id="c_weight5" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_c5' type='text' id="loc_c5" value='' size='3' /></td>
                                                    <td><div align="right">แม่เหล็ก 2นน.&nbsp;</div></td>
                                                    <td><input name='p_weight5' type='text' id="p_weight5" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_p5' type='text' id="loc_p5" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                    <td><div align="right">แม่เหล็ก 2นน.&nbsp;</div></td>
                                                    <td><input name='u_weight5' type='text' id="u_weight5" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_u5' type='text' id="loc_u5" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name='c_bag_qty1' type='text' id="c_bag_qty1" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_c_weight1()"/>
                                                        ถุง&nbsp;&nbsp;
                                                        <input name='c_bag_weight1' type='text' id="c_bag_weight1" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_c_weight1()" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kg.</td>
                                                    <td><div align="right"> ฝุ่นร่อน:จำนวน </div></td>
                                                    <td><input name='p_bag_qty1' type='text' id="p_bag_qty1" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_p_weight1()"/>
                                                        ถุง&nbsp;&nbsp;
                                                        <input name='p_bag_weight1' type='text' id="p_bag_weight1" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_p_weight1()"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kg.</td>
                                                    <td><div align="right"> ฝุ่นร่อน:จำนวน </div></td>
                                                    <td><input name='u_bag_qty1' type='text' id="u_bag_qty1" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_u_weight1()"/>
                                                        ถุง&nbsp;&nbsp;
                                                        <input name='u_bag_weight1' type='text' id="u_bag_weight1" value='' size='3' onKeyUp="IsNuber(this.value, this)" onBlur="cal_u_weight1()"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kg.</td>
                                                </tr>  
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td><div align="right">กองที่</div></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name='c_weight6' type='text' id="c_weight6" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_c6' type='text' id="loc_c6" value='' size='3' /></td>
                                                    <td><div align="right"> ฝุ่นร่อน: </div></td>
                                                    <td><input name='p_weight6' type='text' id="p_weight6" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_p6' type='text' id="loc_p6" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                    <td><div align="right"> ฝุ่นร่อน: </div></td>
                                                    <td><input name='u_weight6' type='text' id="u_weight6" value='' size='3' onBlur="IsNuber(this.value, this);"/>
                                                        kg.
                                                        <input name='loc_u6' type='text' id="loc_u6" value='' size='3' onBlur="IsNuber(this.value, this);"/></td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
