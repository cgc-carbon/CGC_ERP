            ...
            <div align="center">
                <table  cellpadding="0"  cellspacing="0">
                    <tr >
                        ...
                        <td  class="ftopcenter" colspan="2">ผลวิเคราะห์คุณภาพถ่านออกจากเตา 
                                ...
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="503" class="columnobject">
                                            ...
                                            &nbsp;<a href='#' onClick="OpenDoc_id_approve()" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        </td>
                                    </tr>                                    
                                    <tr>
                                        ...
                                        <td colspan="2" align="center">
                                            <div style="width:100%;">
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner3">
                                                    ...
                                                    <tr>
                                                        <td colspan="5" class="h_multi">ข้อมูลการวิเคราะห์</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="row3" width="15%">วันที่<br><a id='date_2' ><input name="tdate1" type="text" id="tdate1" size="10" onmousedown="Calendar.setup({inputField:'tdate1',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_2',singleClick:true,step:1});"></a></td>
                                                        <td class="row3" width="15%">หมายเลขเตา<br><input name="tname1" type="text" id="tname1" size="10" maxlength="1" ></td>
                                                        <td class="row3" width="15%">เวลา (น.)<br><input name='ttime1' type='text' id="ttime1" value='' size='10' maxlength="5"  onkeypress="Time_picker(this.id)" /></td>                                                             
                                                        <td class="row3" width="15%">วันที่<br><a id='date_3' ><input name="tdate2" type="text" id="tdate2" size="10" onmouseover="Calendar.setup({inputField:'tdate2',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_3',singleClick:true,step:1});"></a></td>
                                                        <td class="row3" width="15%">หมายเลขเตา<br><input name="tname2" type="text" id="tname2" size="10" maxlength="1"></td>
                                                        <td class="row3" width="15%">เวลา (น.)<br><input name='ttime2' type='text' id="ttime2" value='' size='10' maxlength="5"  onkeypress="Time_picker(this.id)" /></td> 
                                                        <td class="row3" width="15%">วันที่<br><a id='date_4' ><input name="tdate3" type="text" id="tdate3" size="10" onmouseover="Calendar.setup({inputField:'tdate3',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_4',singleClick:true,step:1});"></a></td>
                                                        <td class="row3" width="15%">หมายเลขเตา<br><input name="tname3" type="text" id="tname3" size="10" maxlength="1"></td>
                                                        <td class="row3" width="15%">เวลา (น.)<br><input name='ttime3' type='text' id="ttime3" value='' size='10' maxlength="5"  onkeypress="Time_picker(this.id)" /></td>                                                        
                                                    </tr>
                                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><input name="approve_id" type="text" id="approve_id" size="15">
                                            <a href='#' onClick="openBrWindow('Vemployee1', 313, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
