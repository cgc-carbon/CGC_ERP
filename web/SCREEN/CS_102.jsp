                                ...
                                <table width="94%"  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td width="600" class="columnobject">
                                            <input type='text' name='doc_id' size='10' value='' />&nbsp;<a href='javascript:;'><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                            วันที่เอกสาร*&nbsp;
                                            <input type='text' name='doc_date' size='10' value='' />
                                            &nbsp;<a href="javascript:;" id='date_1'><img name='IMAGE2' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField:'doc_date',ifFormat:'%Y-%m-%d',showsTime:false,button:'date_1',singleClick:true,step:1});</script>&nbsp;&nbsp;
                                            เวลา*&nbsp;
                                            <input type='text' name='doc_time' size='10' value='' />                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td class="columnobject"><input type='text' name='wh_emp_id' size='10' value='' /> 
                                        &nbsp;<a href='javascript:;'><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a></td>
                                    </tr>
                                    <tr>
