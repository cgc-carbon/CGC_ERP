                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input type="text" name="c_type1" id="c_type1" value="<%=c_type1%>"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">บิวเทน*&nbsp;</td>
                                <td class="columnobject"><input type="text" name="bu1" id="bu1" value="<%=bu1%>" onkeypress="IsNuber(this.value, this)"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เฉลี่ย&nbsp;</td>
                                <td class="columnobject"><input type="text" name="avg1" id="avg1" value="<%=avg1%>"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel"></td>
                            ...
                            <tr>
                                <td class="columnlabel">ชนิด*&nbsp;</td>
                                <td class="columnobject"><input type="text" name="c_type2" id="c_type2" value="<%=c_type2%>"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">บิวเทน*&nbsp;</td>
                                <td class="columnobject"><input type="text" name="bu2" id="bu2" value="<%=bu2%>" onkeypress="IsNuber(this.value, this)"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เฉลี่ย&nbsp;</td>
                                <td class="columnobject"><input type="text" name="avg2" id="avg2" value="<%=avg2%>"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel"></td>
                            ...
                            <tr>
                                <td class="columnlabel">ชนิด*&nbsp;</td>
                                <td class="columnobject"><input type="text" name="c_type3" id="c_type3" value="<%=c_type3%>"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">บิวเทน*&nbsp;</td>
                                <td class="columnobject"><input type="text" name="bu3" id="bu3" value="<%=bu3%>" onkeypress="IsNuber(this.value, this)"/></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เฉลี่ย&nbsp;</td>
                                <td class="columnobject"><input type="text" name="avg3" id="avg3" value="<%=avg3%>"/></td>
                            </tr>                            
                            <tr>
