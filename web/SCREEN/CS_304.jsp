            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2"><DIV id="u4_rtf">
                            <DIV id="u4_rtf2">
                                <DIV id="u9_rtf">
                                    <DIV id="u4_rtf3">ใบแจ้งคืนถ่านกัมมันต์ที่เหลือจากการผลิตเข้าคลังสินค้า(คลังสินค้า)(CS_304)</DIV>
                                </DIV>
                            </DIV>
                        </DIV></td>
                    ...
                    <td  colspan="2" class="fcentercenter"><div align="center">
                            <table width="94%"  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td width="600" class="columnobject"><input name='doc_id' type='text' id="doc_id" value='' size='10' readonly/>
                                        &nbsp;
                                        <a href='javascript:;' onClick="openBrWindow('vd_carbon_return_header_wh&stadment=and+complete_flag+=+\'N\'+and+doc_type+=+\'N\'', 304, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
                                        <a href='javascript:;' onClick="openBrWindow('vd_carbon_return_header_wh&stadment=and+complete_flag+=+\'N\'+and+doc_type+=+\'Y\'', 304, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
                                        วันที่เอกสาร*&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject"><input name='prd_emp_id' type='text' id="prd_emp_id" value='' size='10' readonly/>
                                        &nbsp;<!--<a href='javascript:;' onClick="openBrWindow('mdepartment', 103, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>-->&nbsp;&nbsp;&nbsp;
                                        <input name='prd_emp_id_desc' type='text' id="prd_emp_id_desc" value='' size='30' readonly/>
                                        &nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" align="center"><div align="right"><span class="columnobject">ผู้รับคืน*
                                                <input name='wh_emp_id' type='text' id="wh_emp_id" value='' size='10'readonly />
                                                &nbsp;<a href='javascript:;' onClick="openBrWindow('Vemployee', 103, 'Search_Config2.jsp')" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                                <input name='wh_emp_id_desc' type='text' id="wh_emp_id_desc" value='' size='20' readonly/>
                                                &nbsp;&nbsp;&nbsp;ผู้นำส่ง*
                                                <input name='sending_id' type='text' id="sending_id" value='' size='10' readonly/>
                                                &nbsp;<!--<a href='javascript:;' onClick="openBrWindow('Vemployee1', 103, 'Search_Config2.jsp')" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>-->
                                                <input name='sending_id_desc' type='text' id="sending_id_desc" value='' size='20' readonly/>
                                                &nbsp;&nbsp;</span></div></td>
                                </tr>
                                <tr>
