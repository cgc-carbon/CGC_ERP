                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    &nbsp;<a href='#' onClick="openBrWindow('vd_packing_req_header&stadment=and+complete_flag+<>+\'Y\'', 38, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
	          		วันที่เอกสาร*&nbsp;
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='job_id' type='text' id="job_id" value='' size='10' readonly="readonly"/>
                                    &nbsp;<a href='#' onClick="javascript:openBrWindow('Vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'', 38, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='job_id_desc' type='text' id="job_id_desc" value='' size='30' readonly="readonly"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='bag' type='text' id="bag" value='' size='30' />
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">ถ่านที่บรรจุ*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='carbon_pack' type='text' id="carbon_pack" value='' size='10' />
                                    &nbsp;&nbsp;
	          		I2&nbsp;
                                    <input name='i2' type='text' id="i2" value='' size='10' />
                                </td>
                            </tr>
                            <tr>
                                <td class="columnlabel">สถานที่บรรจุ*&nbsp;</td>
                                <td class="columnobject">
                                    <input name='place_pack' type='text' id="place_pack" value='' size='30' />
                                </td>
                            </tr>
                            <tr>
