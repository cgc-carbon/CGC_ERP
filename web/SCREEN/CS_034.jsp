...
%>
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2">ใบแจ้งการเบิกถ่านกัมมันต์ไปใช้ในการผลิต(CS_034)&nbsp;</td>
                    ...
                    <td  colspan="2" class="fcentercenter">
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        &nbsp;<a href='#' onClick="javascript:openBrWindow('vd_carbon_withdraw_header&stadment=and+complete_flag+<>+\'Y\'+and+count_send_complete+=+\'0\'',34,'Search_Doc_id.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                    <a href='#' title="ค้นหาข้อมูลที่ทำเบิกที่กลับมาแก้ไข"  onClick="openBrWindow('vd_carbon_withdraw_header&stadment=and+complete_flag+<>+\'Y\'+and+count_send_complete+<>+\'0\'', 34, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาข้อมูลที่ทำเบิกที่กลับมาแก้ไข' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
	          		วันที่เอกสาร*&nbsp;
	          		...
	          		เวลา*&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        <input name='work_type' type='text' id="work_type" value='' size='10' />&nbsp;<a href='#' onClick="javascript:openBrWindow('mjob_type',34,'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>                                </td>
