...
%>
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr >
                    ...
                    <td  class="ftopcenter" colspan="2">รายงานถ่านออกจากเตา(CS_029)&nbsp;</td>
                            ...
                            <table   cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td width="607" class="columnobject">
                                        <input name='doc_id' type='text' id="doc_id" value='' size='15' onBlur="ChkDoc_id();"/> &nbsp;
                                        &nbsp;<a href='#' onClick="openBrWindow('vd_carbon_burn_out_header&stadment=and+complete_flag+<>+\'Y\'', 29, '../JSP/Search_Doc_id2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                        <a href='#' title="ค้นหาข้อมูลที่ทำเบิกที่กลับมาแก้ไข"  onClick="openBrWindow('vd_carbon_burn_out_header&stadment=and+complete_flag+<>+\'Y\'+and+count_send_complete+<>+\'0\'', 29, '../JSP/Search_Doc_id2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาข้อมูลที่ทำเบิกที่กลับมาแก้ไข' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        วันที่เอกสาร*&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        &nbsp;&nbsp;&nbsp;<a href='#' onClick="openBrWindow('Vemployee1&stadment=and+dept_id+=+\'002\'', 29, '../JSP/Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='runner_id_desc' type='text' id="runner_id_desc" value='' size='30' readonly="readonly"/>	          	</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        <input name='burn_no' type='text' id="burn_no" value='' size='10' />
                                        &nbsp;&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        <input name='ch_from' type='text' id="ch_from" value='' size='10' />
                                        &nbsp;&nbsp;
                                        ถึง*&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input name='ch_to' type='text' id="ch_to" value='' size='10' />	          	</td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">น้ำหนักก่อนร่อนแยก*&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='weight_split' type='text' id="weight_split" value='0' size='10' onBlur="IsNumber2(this.value, this);"/>
                                        &nbsp;&nbsp;
                                        วันที่*&nbsp;
                                        <input type='text' name='burn_out_date' id="burn_out_date" size='10' value='' readonly="readonly"/>&nbsp;<a id='date_3' ><img name='IMAGE6' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField:'burn_out_date',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_3',singleClick:true,step:1});</script>	          	</td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2" align="center">
                                        <div style="width:100%;">
                                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="1" class="inner">
                                                <tr>
                                                    <td colspan="5" class="h_multi">ข้อมูลถ่านออกจากเตา</td>
                                ...
                                <tr>
                                    <td colspan="2" align="right">
                                        ผู้รายงาน
                                        <input name="report_id" type="text" id="report_id" size="10">
                                        <a href='#' onClick="openBrWindow('Vemployee', 29, '../JSP/Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE4' width='20' height='20' border='0' align='middle' ></a>
                                        <input name="report_id_desc" type="text" id="report_id_desc" size="20">
                                        &nbsp;&nbsp;&nbsp;&nbsp;สูญเสีย*&nbsp;
