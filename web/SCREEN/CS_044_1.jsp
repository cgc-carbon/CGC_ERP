                        ...
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    ...
                                    <!--
                                <input name='product_id' type='text' id="product_id" value='<%=product_id%>' size='10' readonly/>
                                                    &nbsp;<a href='#' onClick="javascript:openBrWindow('Vproduct', 44, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE2' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='product_id_desc' type='text' id="product_id_desc" value='' size='30' readonly/>	-->          	</td>
                            </tr>
                            <tr>
