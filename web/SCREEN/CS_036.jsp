...
%>
                ...
                <table  cellpadding="0"  cellspacing="0">
                    <tr>
                        ...
                        <td  class="ftopcenter" colspan="2"><%=screen_name%>(CS_036)&nbsp;</td>
                            ...
                            <div align="left">
                                <table  cellpadding="0" cellspacing="0" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            <input name='doc_id' type='text' id="doc_id" value='' size='25' />
                                            &nbsp;<a href='#' onClick="openBrWindow('vd_product_receive_header&stadment=and+complete_flag+=+\'N\'+and+count_send_complete+=+\'0\'', 36, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                            <a href='#' onClick="openBrWindow('vd_product_receive_header&stadment=and+complete_flag+=+\'N\'+and+count_send_complete+<>+\'0\'', 36, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                            วันที่เอกสาร*&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject"><input name='job_id' type='text' id="job_id" value='' size='10' readonly="readonly"/>
                                            <!--&nbsp;<a href='#' onClick="openBrWindow('Vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'+and+(doc_type+is+null+or+doc_type<>\'Y\')', 36, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='job_id_desc' type='text' id="job_id_desc" value='' size='30' readonly="readonly"/-->                                
                                            &nbsp;<a href='#' onClick="openBrWindow('Vd_job_order_header&stadment=and+(delete_flag<>\'Y\')', 36, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='job_id_desc' type='text' id="job_id_desc" value='' size='30' readonly="readonly"/>                                
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="columnobject">
                                            ...
                                            &nbsp;&nbsp;
                                            ขนาด*&nbsp;
                                            <input name='size' type='text' id="size" value='' size='10' readonly/>                                </td>
                                    </tr>
                                    <tr>
                                        <td class="columnlabel">I2*&nbsp;</td>
                                        <td class="columnobject">
                                            <input name='ctc_i2' type='text' id="ctc_i2" value='' size='10' readonly/>
                                            &nbsp;&nbsp;
                                            ยอดยกมา*&nbsp;
                                            <input name='inc_bal' type='text' id="inc_bal" value='' size='10' />     
                                            &nbsp;&nbsp;
                                            พาเลทที่ยกมา*&nbsp;                                        
                                            <input name='palate_no' type='text' id="palate_no" value='' size='10' />  
                                        </td>
                                    </tr>
                                    <!--tr>
