                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td colspan="15" class="columnobject"><input type='text' name='bag' size='20' id="bag"  value="<%=bag%>" />                            &nbsp;&nbsp;&nbsp;&nbsp;</td>
                            </tr>
                            <tr>
                                <td height="28" class="columnlabel">แหล่งผลิต*&nbsp;</td>
                                <td colspan="15" class="columnobject"><input name="prd_place" type="text" id="prd_place" size="20" value="<%=prd_place%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">เลท*&nbsp;</td>
                                <td colspan="15" class="columnobject"><input name="lat" type="text" id="lat" size="20" value="<%=lat%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">รหัสผลิต*&nbsp;</td>
                                <td colspan="15" class="columnobject"><input name="prd_code" type="text" id="prd_code" size="20" value="<%=prd_code%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">H2O(%)*</td>
                                <td colspan="15" class="columnobject"><input name="h2o" type="text" id="h2o" size="20" value="<%=h2o%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">B.A.(%)*&nbsp;</td>
                                <td colspan="15" class="columnobject"><input name="ba" type="text" id="ba" size="20" value="<%=ba%>"></td>
                            </tr>
                            <tr>
                                <td height="22" class="columnlabel">ไอโอดีน(mg/g)*&nbsp;</td>
                                <td colspan="15" class="columnobject"><input name="iod" type="text" id="iod" size="20" value="<%=iod%>"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="columnlabel">&nbsp;</td>
                                <td class="columnobject"><input name="hd1" type="text" id="hd1" size="5" value="<%=hd1%>"></td>
                                <td class="columnobject"><input name="hd2" type="text" id="hd2" size="5" value="<%=hd2%>"></td>
                                <td class="columnobject"><input name="hd3" type="text" id="hd3" size="5" value="<%=hd3%>"></td>
                                <td class="columnobject"><input name="hd4" type="text" id="hd4" size="5" value="<%=hd4%>"></td>
                                <td class="columnobject"><input name="hd5" type="text" id="hd5" size="5" value="<%=hd5%>"></td>
                                <td class="columnobject"><input name="hd6" type="text" id="hd6" size="5" value="<%=hd6%>"></td>
                                <td class="columnobject"><input name="hd7" type="text" id="hd7" size="5" value="<%=hd7%>"></td>
                                <td class="columnobject"><input name="hd8" type="text" id="hd8" size="5" value="<%=hd8%>"></td>
                                <td class="columnobject"><input name="hd9" type="text" id="hd9" size="5" value="<%=hd9%>"></td>
                                <td class="columnobject"><input name="hd10" type="text" id="hd10" size="5" value="<%=hd10%>"></td>
                                <td class="columnobject"><input name="hd11" type="text" id="hd11" size="5" value="<%=hd11%>"></td>
                                <td class="columnobject"><input name="hd12" type="text" id="hd12" size="5" value="<%=hd12%>"></td>
                                <td class="columnobject"><input name="hd13" type="text" id="hd13" size="5" value="<%=hd13%>"></td>
                                <td class="columnobject"><input name="hd14" type="text" id="hd14" size="5" value="<%=hd14%>"></td>
                                <td class="columnobject"><input name="hd15" type="text" id="hd15" size="5" value="<%=hd15%>"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="15" class="columnobject"><textarea name="remark" id="remark" cols="45" rows="5"><%=remark%></textarea></td>
                            </tr>
