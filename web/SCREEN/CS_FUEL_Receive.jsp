...
<html>
 ...
 /*           
            function Opendoc_id(input)
            {
                switch (input) {
                    case 1:
                    //openBrWindow('Vd_fuel_receive&stadment=and+complete_flag+=+\'N\'', 22, '../JSP/Search_Doc_id.jsp');
                    openBrWindow('Vd_fuel_receive&stadment', 22, '../JSP/Search_Doc_id.jsp');
                    break;
                    case 2:
                    openBrWindow('Vd_fuel_receive&stadment=and+complete_flag+=+\'Y\'', 22, '../JSP/Search_Doc_id.jsp');
                    break;
                }
...
*/            
            ...
            function Opendoc_id(input)
            {
                switch (input) {
                    case 1:
                        openBrWindow('Vd_fuel_receive&stadment=and+complete_flag+<>+\'Y\'', 22, '../JSP/Search_Config2.jsp');                        
                        break;
                    case 2:
                        openBrWindow('Vd_fuel_receive&stadment=and+complete_flag+<>+\'N\'', 22, '../JSP/Search_Config2.jsp');
                        break;
                    default:
                        break;
                }
                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="columnobject">
                                        ...
                                        <b>เลขที่เอกสาร(เอกสารสมบูรณ์แล้ว)</b>&nbsp;<a href='#' onClick="Opendoc_id(2)" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                    </td>
                                </tr>                           
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="columnobject">
                                        ...
                                        &nbsp;<a href='#' onClick="openBrWindow('Vsupplier', 221, '../JSP/Serch_Config.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='supplier_id_desc' type='text' id="supplier_id_desc" value='' size='20' readonly="readonly" />
                                ...
                                <tr>
                                    <td class="columnlabel">เลขที่ใบชั่งน้ำหนัก*&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <input name='scale_no' type='text' id="scale_no" value='' size='15' />	          	</td>
                                </tr>                                   
                                <tr>
                                    <td class="columnlabel">วันที่รถเข้า*</td>
                                    <td colspan="3" class="columnobject"><input name="car_date_in" type="text" id="car_date_in" size="10" readonly><a id='date_2'><img name='IMAGE2' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField: 'car_date_in', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_2', singleClick: true, step: 1});</script>
                                        เวลา*&nbsp;
                                        <input name='car_time_in' type='text' id="car_time_in" value='' size='5' onkeypress="Time_picker(this.id)"/></td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">วันที่รถออก*</td>
                                    <td colspan="3" class="columnobject"><input name="car_date_out" type="text" id="car_date_out" size="10" readonly><a id='date_3'><img name='IMAGE2' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField: 'car_date_out', ifFormat: '%d-%m-%Y', showsTime: false, button: 'date_3', singleClick: true, step: 1});</script>
                                        เวลา*&nbsp;
                                        <input name='car_time_out' type='text' id="car_time_out" value='' size='5' onkeypress="Time_picker(this.id)"/></td>
                                </tr>                                         
                                <tr>
                                    <td class="columnlabel"><span class="columnobject">เลขทะเบียนรถ*</span></td>
                                    <td colspan="3" class="columnobject"><input name='car_no' type='text' id="car_no" value='' size='40' />
                                        &nbsp;&nbsp;
                                        ชื่อคนขับ*&nbsp;
                                        <input name='driver_name' type='text' id="driver_name" value='' size='30' /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="columnlabel">คลัง/โกดัง/สถานที่จัดเก็บ*&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <!--input name='wh_in' type='text' id="wh_in" value='<%=objs_p.getWarehouse_begin_id()%>' size='10' readonly="readonly"/>                                        
                                        <a href='#' onClick="openBrWindow('Mwarehouse&stadment=and+wh_type+=+\'F\'', 22, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='wh_name' type='text' id="wh_name" value='<%=objs_p.getWarehouse_begin_name()%>' size='30' readonly="readonly" />                                </td-->
                                        <input name='wh_in' type='text' id="wh_in" value='' size='10' readonly="readonly"/>                                        
                                        <a href='#' onClick="openBrWindow('Mwarehouse&stadment=and+wh_type+=+\'F\'', 22, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;<input name='wh_name' type='text' id="wh_name" value='' size='30' readonly="readonly" />                                </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="columnlabel">น้ำหนักเข้า*&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <input name='car_weight_in' type='text' id="car_weight_in" value='' size='10' />&nbsp;กิโลกรัม&nbsp;	          	
                                        น้ำหนักออก*&nbsp;                                    
                                        <input name='car_weight_out' type='text' id="car_weight_out" value='' size='10' onBlur="cal_total_weight()"/>&nbsp;กิโลกรัม&nbsp;	          	</td>
                                </tr>  

                                <tr>
                                    <td class="columnlabel">น้ำหนักเข้า - น้ำหนักออก&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <input name='net_weight_receive' type='text' id="net_weight_receive" value='' size='10' readonly="readonly"/>&nbsp;กิโลกรัม&nbsp;	          	</td>
                                </tr>                                 

                                <tr>
                                    <td class="columnlabel"><b>สถานะการหักค่าความชื้น*</b>&nbsp;</td>
                                ...
                                <tr>
                                    <td class="columnlabel">ค่าความชื้น&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <input name='moisture' type='text' id="moisture" value='' size='3' onBlur="cal_deduct_weight()"/>&nbsp;%&nbsp;
                                        เกณฑ์ค่าความชื้น&nbsp; 
                                        <input name='moisture_std' type='text' id="moisture_std" value='' size='3' onBlur="cal_deduct_weight()"/>&nbsp;%&nbsp;
                                        หักน้ำหนักค่าความชื้น&nbsp; 
                                        <input name='deduct_weight_moisture' type='text' id="deduct_weight_moisture" value='' size='10' onBlur="cal_adjust_decimal()"/>&nbsp;กิโลกรัม&nbsp;	          	
                                    </td>
                                </tr>                                  
                                <tr>
                                    <td class="columnlabel">น้ำหนักสุทธิ*&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <input name='total_weight' type='text' id="total_weight" value='' size='10' />&nbsp;กิโลกรัม&nbsp;	          	</td>
                                </tr>    
                                <tr>
                                    <td class="columnlabel">ราคา/หน่วย&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <input name='price_unit' type='text' id="price_unit" value='' size='10' onBlur="cal_total_price()"/>&nbsp;บาท&nbsp;	          
                                        จำนวนเงินรวม&nbsp;                                    
                                        <input name='total_price' type='text' id="total_price" value='' size='10' />&nbsp;บาท&nbsp;
                                    </td>
                                </tr>          

                                <tr>
                                    <td class="columnlabel">จำนวนเงินรวม (ตัวอักษร)&nbsp;</td>
                                    <td colspan="3" class="columnobject">
                                        <input name='net_weight_payment' type='text' id="net_weight_payment" value='' size='70' />&nbsp;&nbsp;	          	
                                    </td>
                                </tr>                                  

                                <tr>
                                    <td class="columnlabel">ผู้รายงาน</td>
                                    <td class="columnobject"><input name="reporter_id" type="text" id="reporter_id" size="10">
                                        <a href='#' onClick="openBrWindow('Vemployee', 313, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        <input name="reporter_id_desc" type="text" id="reporter_id_desc" size="30">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">ผู้ตรวจสอบ</td>
                                    <td class="columnobject"><input name="checker1" type="text" id="checker1" size="10">
                                        <a href='#' onClick="openBrWindow('Vemployee2', 313, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        <input name="checker1_desc" type="text" id="checker1_desc" size="30">
                                    </td>
                                </tr>                                

                                <tr>
                                    <td class="columnlabel">หมายเหตุ&nbsp;</td>
                                    <td colspan="3" class="columnobject"><textarea name='remark' cols='40' rows='5' id="remark" value='-'"></textarea></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan='4' class='blankspace'>
                                        ...
                                        <div align="center">
                                            ...
                                            <a href="javascript:;" onClick="confirmDialogDelete(URLsend('doc_id,username,status_d', '../JSP/CS_FULE_Receive.jsp'));"><img alt=""  src="../IMAGES/BTN_DEL_90.png" width="80" height="30" border="0"></a>
