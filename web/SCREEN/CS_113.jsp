                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td colspan="15" class="columnobject"><input type='text' name='pkg_shift' size='20' id="pkg_shift"  value="<%=packing_shift%>" />
&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            </tr>
                            <tr>
                                <td height="28" class="columnlabel">Packing Code*&nbsp;</td>
                              <td colspan="15" class="columnobject"><input name="pkg_code" type="text" id="pkg_code" size="20" value="<%=packing_code%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">Weight*&nbsp;</td>
                              <td colspan="15" class="columnobject"><input name="weight" type="text" id="weight" size="20" value="<%=weight%>"></td>
                            </tr>
                            <tr>
