            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr>
                    ...
                    <td  class="ftopcenter" colspan="2"><DIV id="u4_rtf4">
                            <DIV id="u4_rtf5">
                                <DIV id="u9_rtf2">วิเคราะห์คุณภาพถ่าน(CS_105)</DIV>
                            </DIV>
                        </DIV></td>
                ...
                <tr >
          	    ...
          	    ตรวจสอบแล้ว</td>
                                ...
                                <tr>
                                    ...
                                    <td width="600" class="columnobject"><input name='doc_id' type='text' id="doc_id" value='' size='25'/>
                                        <!--&nbsp;<a href='javascript:;' onClick="openBrWindow('vd_carbon_analyze_header&stadment=and+complete_flag+<>+\'Y\'', 105, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;-->
                                        &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_carbon_analyze_header&stadment=and+approve_status+<>+\'Y\'', 105, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;                                        
                                        วันที่เอกสาร*&nbsp;
                                        <input name='doc_date' type='text' id="doc_date" size='10' readonly/>
                                        ...
                                        เอกสารที่ตรวจสอบแล้ว<a href='javascript:;' onClick="openBrWindow('vd_carbon_analyze_header&stadment=and+approve_status+=+\'Y\'', 105, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject"><select name='shift' id="shift">
                                        ...
                                        &nbsp;เวลา
                                        <input name="doc_time" type="text" id="doc_time" size="20"</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td height="208" colspan="2" align="center"><div style="width:100%;">
                                            <table width="200" border="0" cellpadding="0" cellspacing="1">
                                                <tr>
                                                    <td colspan="5" class="h_multi">ข้อมูลการวิเคราะห์คุณภาพถ่าน</td>
                                ...
                                <tr>
                                    <td colspan="2" align="center"><div align="right"><span class="columnobject">ผู้รายงาน*
                                                <input name='reporter_id' type='text' id="reporter_id" value='' size='10' readonly/>
                                                &nbsp;<a href='javascript:;' onClick="openBrWindow('Vemployee', 105, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                                <input name='reporter_id_desc' type='text' id="reporter_id_desc" value='' size='20' readonly/>
                                                &nbsp;&nbsp;&nbsp;
                                                ผู้ตรวจ*
                                                <input name='checker_id' type='text' id="checker_id" value='' size='10' readonly/>
                                                &nbsp;<a href='javascript:;' onClick="openBrWindow('Vemployee1', 105, 'Search_Config2.jsp')"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;
                                                <input name='checker_id_desc' type='text' id="checker_id_desc" value='' size='20' readonly/>
                                                &nbsp;&nbsp;</span></div></td>
                                </tr>
                                <tr>
