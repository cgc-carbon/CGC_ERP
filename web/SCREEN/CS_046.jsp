        ...
        <script type="text/javascript">
            ...
            function AddHeader()
            {
                ...
                if(r)
                {
                    ...
                    getSave(URLsend('chkNull,doc_id,doc_date,car_no,c_type,sender_id,report_id,approve_id,approve_status,username,car_date_in','../JSP/CS_046.jsp'));
                    getId("show").innerHTML = "";
                    getId("doc_id").disabled = false;
                }
            }
            ...
            function OpenBrown()
            {
                cancelAction();
                getId("show").innerHTML = "";
                openBrWindow('Vd_rawmatt_receive&stadment=and+complete_flag+=+\'N\'+and+lab_not_check+<>+\'Y\'+and+doc_type+=+\'N\'+and+check_doc_transfer IS NULL', 46, '../JSP/Search_Config2.jsp');                                
            }
...
%>
            ...
            <table  cellpadding="0"  cellspacing="0">
                <tr >
                    ...
                    <td  class="ftopcenter" colspan="2">ใบวิเคราะห์คุณภาพวัตถุดิบ(CS_046)&nbsp;</td>
                    ...
                    <td  colspan="2" class="fcentercenter">
                        <div align="left">
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    <td class="columnlabel"><b>เลขที่ใบรับถ่าน*</b>&nbsp;</td>
                                    <td class="columnobject">
                                        <input name='doc_id' type='text' id="doc_id" value='' size='10' />
                                        &nbsp;<a href='#' onClick="OpenBrown()" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเลขที่ใบชั้งถ่านจากใบรับวัตถุดิบ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;
                                        &nbsp;<a href='#' onClick="openBrWindow('vd_rawmatt_analyze_header', 46, '../JSP/Search_Doc_id3.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเลขที่ใบชั้งจากใบวิเคราะห์วัตถุดิบ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;                                        
                                        <!--a href='#' onClick="openBrWindow('vd_rawmatt_analyze_header&stadment=and+complete_flag+<>+\'Y\'', 46, '../JSP/Search_Doc_id.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเลขที่ใบชั้งจากใบวิเคราะห์วัตถุดิบ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a-->
                                        วันที่วิเคราะห์ฯ*&nbsp;
                                        <input type='text' name='doc_date' id="doc_date" size='10' value='' />&nbsp;<a id='date_1'><img name='IMAGE2' src='../IMAGES/BUTTON/MAIN/CALENDAR20.gif' border='0' align='absmiddle'></a><script type='text/javascript'>Calendar.setup({inputField:'doc_date',ifFormat:'%d-%m-%Y',showsTime:false,button:'date_1',singleClick:true,step:1});</script>&nbsp;&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">เอกสารที่ส่งผลวิเคราะห์แล้ว&nbsp;
                                    </td>
                                    <td class="columnobject">
                                        &nbsp;<a href='#' onClick="openBrWindow('vd_rawmatt_analyze_header&stadment=and+complete_flag+=+\'Y\'+and+approve_status+=+\'Y\'', 46, '../JSP/Search_Doc_id.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเลขที่ใบชั้งจากใบวิเคราะห์วัตถุดิบ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;                                
                                    </td>
                                </tr>                             
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        ชนิดถ่าน*&nbsp;
                                        <input name='c_type' type='text' id="c_type" value='' size='10' />
                                        &nbsp;&nbsp;วันที่รถเข้า<input name="car_date_in" type="text" id="car_date_in" size="10">                                </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">ผู้ส่ง&nbsp;
                                    </td>
                                    <td class="columnobject">
                                        <input name='sender_id' type='text' id="sender_id" value='' size='10' />
                                        <!--<a href='#' onClick="openBrWindow('Vemployee', 46, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเลขที่ใบชั้งถ่านจากใบรับวัตถุดิบ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>-->
                                        <input name='sender_id_desc' type='text' id="sender_id_desc" value='' size='20' />
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="2" align="center">
                                        <div style="width:100%;">
                                            ...
                                            <table width="100%" align="center" border="5" cellpadding="0" cellspacing="1" class="inner" id="tbExp" >
                                                <tr>
                                                    <td colspan="4" class="h_multi">ผลการวิเคราะห์</td>
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        <input name='report_id' type='text' id="report_id" value='' size='10' />
                                        <a href='#' onClick="openBrWindow('Vemployee1', 46, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเลขที่ใบชั้งถ่านจากใบรับวัตถุดิบ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        <input name='report_id_desc' type='text' id="report_id_desc" value='' size='15' />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ผู้ตรวจ&nbsp;
                                        <input name='approve_id' type='text' id="approve_id" value='' size='10' />
                                        <a href='#' onClick="openBrWindow('Vemployee2', 46, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหาเลขที่ใบชั้งถ่านจากใบรับวัตถุดิบ' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>
                                        <input name='approve_id_desc' type='text' id="approve_id_desc" value='' size='15' />
                                    </td>
                                </tr>
