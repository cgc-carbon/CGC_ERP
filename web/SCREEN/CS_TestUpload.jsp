                            ...
                            <table  cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="columnobject">
                                        <input name='A_doc_id' type='text' id="A_doc_id" value='' size='10'  />
                                        &nbsp;<a href='#' onClick="OpenDoc_id()" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;                                </td>
                                </tr>
                                <tr>
                                    <td class="columnlabel">ผู้เบิก </td>
                                    <td class="columnobject">
                                        <input type='text' id="runner_id" name='runner_id' size='10' value='' readonly="readonly"/>&nbsp;&nbsp;<a href='#' onClick="javascript:openBrWindow('Vemployee&stadment=and+emp_id+between+\'0001\'+and+\'0008\'', 23, '../JSP/Search_Config2.jsp');" ><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE3' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='runner_id_desc' id="runner_id_desc" size='30' value='' readonly="readonly"/>                                </td>
                                </tr>
                                <tr>
