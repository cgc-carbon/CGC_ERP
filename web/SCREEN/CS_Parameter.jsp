                    ...
                    <div align="center">
                        <table  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name="hc1" type="text" id="hc1" size="30" value="<%=hc1%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">2 &nbsp;</td>
                                <td class="columnobject"><input name="hc2" type="text" id="hc2" size="30" value="<%=hc2%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">3 &nbsp;</td>
                                <td class="columnobject"><input name="hc3" type="text" id="hc3" size="30" value="<%=hc3%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">4 &nbsp;</td>
                                <td class="columnobject"><input name="hc4" type="text" id="hc4" size="30" value="<%=hc4%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">5 &nbsp;</td>
                                <td class="columnobject"><input name="hc5" type="text" id="hc5" size="30" value="<%=hc5%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">6 &nbsp;</td>
                                <td class="columnobject"><input name="hc6" type="text" id="hc6" size="30" value="<%=hc6%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">7 &nbsp; </td>
                                <td class="columnobject"><input name="hc7" type="text" id="hc7" size="30" value="<%=hc7%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">8&nbsp;</td>
                                <td class="columnobject"><input name="hc8" type="text" id="hc8" size="30" value="<%=hc8%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">9&nbsp;</td>
                                <td class="columnobject"><input name="hc9" type="text" id="hc9" size="30" value="<%=hc9%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">10&nbsp;</td>
                                <td class="columnobject"><input name="hc10" type="text" id="hc10" size="30" value="<%=hc10%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">11&nbsp;</td>
                                <td class="columnobject"><input name="hc11" type="text" id="hc11" size="30" value="<%=hc11%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">12&nbsp;</td>
                                <td class="columnobject"><input name="hc12" type="text" id="hc12" size="30" value="<%=hc12%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">13&nbsp;</td>
                                <td class="columnobject"><input name="hc13" type="text" id="hc13" size="30" value="<%=hc13%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">14&nbsp;</td>
                                <td class="columnobject"><input name="hc14" type="text" id="hc14" size="30" value="<%=hc14%>"></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">15&nbsp;</td>
                                <td class="columnobject"><input name="hc15" type="text" id="hc15" size="30" value="<%=hc15%>"></td>
                            </tr>
