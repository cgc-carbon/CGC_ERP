                        ...
                        <table width="94%"  cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <td width="600" class="columnobject"><input name='doc_id' type='text' id="doc_id" value='' size='10' />
                                    &nbsp;<a href='javascript:;' onClick="openBrWindow('vd_qc_report_header&stadment=and+complete_flag+<>+\'Y\'', 112, '../JSP/Search_Doc_id.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>&nbsp;&nbsp;
                                    Stuffing Date*&nbsp;
                            ...
                            <tr>
                                ...
                                <td class="columnobject"><input name='job_no' type='text' id="job_no" value='' size='15' />
                                    <a href='javascript:;' onClick="javascript:openBrWindow('Vd_job_order_header&stadment=and+complete_flag+<>+\'Y\'', 112, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a>Customer&nbsp;&nbsp;&nbsp;<input name='cust_id' type='text' id="cust_id" value='' size='15' />
                                    &nbsp;&nbsp;<input type="text" name='cust_id_desc' id="cust_id_desc" value=""></td>
                            </tr>
                            <!--<tr>
                            ...
                            <tr>
                                ...
                                <td class="columnobject">
                                    <input name='product_id' type='text' id="product_id" value='' size='15' />
                                    <a href='javascript:;' onClick="javascript:openBrWindow('Vproduct', 112, '../JSP/Search_Config2.jsp');"><img src='../IMAGES/BUTTON/MAIN/SEARCH20.gif' alt='ค้นหา' name='IMAGE1' width='20' height='20' border='0' align='middle' ></a><input type="text" name='product_id_desc' id="product_id_desc" value=""></td>
                            </tr>
                            <tr>
                                <td class="columnlabel">Weight*&nbsp;</td>
                                <td class="columnobject"><input name='weight' type='text' id="weight" value='' size='10' />
                                    &nbsp;&nbsp;&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td height="208" colspan="2" align="center"><div style="width:100%;">
                                        <table width="200" border="0" cellpadding="0" cellspacing="1">
                                            ...
                                            <tr>
                                                <td width="10%" class="row3"><input name="hc1" type="text" id="hc1" size="8" readonly></td>
                                                <td width="10%" class="row3"><input name="hc2" type="text" id="hc2" size="8" readonly></td>
                                                <td width="10%" class="row3"><input name="hc3" type="text" id="hc3" size="8" readonly></td>
                                                <td width="10%" class="row3"><input name="hc4" type="text" id="hc4" size="8" readonly></td>
                                                <td width="10%" class="row3"><input name="hc5" type="text" id="hc5" size="8" readonly></td>
                                                <td width="10%" class="row3"><input name="hc6" type="text" id="hc6" size="8" readonly></td>
